        ...
        <Box sx={{
            ...
            <Box className="liquid-glass-card-neutral" sx={{
                ...
                <Box className={styles["chart-ctn"]} sx={{
                    ...
                    <iframe
                        src={
                            "https://awone-api.axiomio.com/grafana/d/ecddfeaf-d0de-4b10-8007-41143c/f7515f8?orgId=1&from=now-1h&to=now&timezone=browser&var-experiment=" +
                            experimentId +
            ...
            {taskType === "sft" && (
                <Box className="liquid-glass-card-neutral" sx={{
                    ...
                    <Box className={styles["chart-ctn"]} sx={{
                        ...
                        <iframe
                            src={"https://awone-api.axiomio.com/grafana/d/b711bbe2-1728-4234-977c-24f08947e994/model-metrics-llm?orgId=1&var-experiment="+experimentId+"&kiosk&theme=light&panelId=5"}
                            width="100%"
                            height="100%"
                            style={{
                                border: "none",
