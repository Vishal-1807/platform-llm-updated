  ...
  const getReports = () => {
    ...
    switch (true) {
      ...
      case reportItem === "Training System Metrics":
        let TSMUrl = `https://api.workbenchai.aubrant.com/cibi/grafana/d/k8s_views_ns/kubernetes-views-namespaces?orgId=1&refresh=30s&var-datasource=Prometheus&var-namespace=${lowerCaseProjectId}-train&theme=light&kiosk&width=450&from=${rangeFromValue}&to=${rangeToValue}`;
        return (
          <>
            <Grid sx={{ width: "100%" }}>
              <Box sx={{ width: "100%" }}>
      ...
      case reportItem === "Preprocessing System Metrics":
        let PSMUrl = `https://api.workbenchai.aubrant.com/cibi/grafana/d/k8s_views_ns/kubernetes-views-namespaces?orgId=1&refresh=30s&var-datasource=Prometheus&var-namespace=${lowerCaseProjectId}-preprocess&theme=light&kiosk&width=450&from=${rangeFromValue}&to=${rangeToValue}`;
        return (
          <>
            <SelectFilter
              value={rangeFromValue}
      ...
      case reportItem === "Inference system Metrics":
        let ISMUrl = `https://api.workbenchai.aubrant.com/cibi/grafana/d/k8s_views_ns/kubernetes-views-namespaces?orgId=1&refresh=30s&var-datasource=Prometheus&var-namespace=${lowerCaseProjectId}-infer&theme=light&kiosk&width=450&from=${rangeFromValue}&to=${rangeToValue}`;
        return (
          <>
            <SelectFilter
              value={rangeFromValue}
      ...
      case reportItem === "Cost":
        let CUrl = `https://api.workbenchai.aubrant.com/cibi/grafana/d/2LaqbJ0Zk/kubecost?orgId=1&refresh=10s&var-namespace=${lowerCaseProjectId}-infer&var-namespace=${lowerCaseProjectId}-preprocess&var-namespace=${lowerCaseProjectId}-train&theme=light&kiosk&width=450&from=${CostrangeFromValue}&to=${rangeToValue}`;
        return (
          <>
            <SelectFilter
      ...
      case reportItem === "Drift Metrics":
        let DTUrl = `https://api.workbenchai.aubrant.com/cibi/grafana/d/d9e2bfd9-c994-4274-8869-1b4cb092f678/drift-metrics?orgId=1&refresh=30s&var-experiment=${experimentId}&theme=light&kiosk&width=450&from=${rangeFromValue}&to=${rangeToValue}`;
        return (
          <>
            <SelectFilter
              value={rangeFromValue}
      ...
      case reportItem === "Load test Metrics":
        let LSMUrl = `https://api.workbenchai.aubrant.com/cibi/grafana/d/b0e1e08e-c158-4328-917b-fdf2a42ae8e1/locust-v1?orgId=1&refresh=30s&var-TestId=${experimentId}&theme=light&kiosk&width=450&from=${rangeFromValue}&to=${rangeToValue}`;
        return (
          <>
            {Showloading && (
              <div>
