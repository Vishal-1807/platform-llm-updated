...
export const Dashboard = () => {
  ...
  const handleChange = (e) => {
    ...
    if (ProjectFilter === "llm") {
      ...
      const single = `https://awone-api.axiomio.com/cibi/llm-dev/grafana/d/a91763bb-d009-4be3-b378-2187a01e08bd/kubecost-llm?orgId=1&refresh=10s&var-namespace=${selectedValue}-train&var-namespace=${selectedValue}-infer&var-namespace=${selectedValue}-preprocess&from=now-20d&to=now&theme=light&kiosk&width=450`;
      setFinalURL(single);
    } else {
