...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React46.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React46.useRef(false);
  const handleEntering = React46.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React46.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React46.useCallback(() => {
    dispatch("exiting");
  }, []);
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3BUEL2DP.js.map
