...
var require_highcharts = __commonJS({
 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
          ...
          return t3.forEach((t4) => {
            if (t4.length > 1)
              for (o2 = t4.length - 1; o2 > 0; o2--)
                (s2 = t4[o2] - t4[o2 - 1]) < 0 && !r2 ? (e3 == null ? void 0 : e3(), e3 = void 0) : s2 && (void 0 === i3 || s2 < i3) && (i3 = s2);
          }), i3;
        ...
        let { win: i2 } = t2, { defined: s, error: o, extend: r, isNumber: n, isObject: a, merge: h, objectEach: l, pad: d, pick: c, splat: p, timeUnits: u } = e2, g = t2.isSafari && i2.Intl && i2.Intl.DateTimeFormat.prototype.formatRange, f = t2.isSafari && i2.Intl && !i2.Intl.DateTimeFormat.prototype.formatRange;
        return class {
          constructor(t3) {
          ...
          makeTime(t3, e3, i3, s2, o2, r2) {
            let n2, a2, h2;
            return this.useUTC ? (n2 = this.Date.UTC.apply(0, arguments), a2 = this.getTimezoneOffset(n2), n2 += a2, a2 !== (h2 = this.getTimezoneOffset(n2)) ? n2 += h2 - a2 : a2 - 36e5 !== this.getTimezoneOffset(n2 - 36e5) || f || (n2 -= 36e5)) : n2 = new this.Date(t3, e3, c(i3, 1), c(s2, 0), c(o2, 0), c(r2, 0)).getTime(), n2;
          }
          timezoneOffsetFunction() {
            let t3 = this, e3 = this.options, i3 = e3.getTimezoneOffset;
            return this.useUTC ? e3.timezone ? (t4) => {
              try {
                let [i4, s2, o2, r2, a2 = 0] = Intl.DateTimeFormat("en", { timeZone: e3.timezone, timeZoneName: "shortOffset" }).format(t4).split(/(GMT|:)/).map(Number), h2 = -(36e5 * (o2 + a2 / 60));
                if (n(h2))
                  return h2;
              } catch (t5) {
                o(34);
          ...
          dateFormat(e3, i3, o2) {
            ...
            e3 = c(e3, "%Y-%m-%d %H:%M:%S");
            let n2 = this, a2 = new this.Date(i3), h2 = this.get("Hours", a2), p2 = this.get("Day", a2), u2 = this.get("Date", a2), g2 = this.get("Month", a2), f2 = this.get("FullYear", a2), m = t2.defaultOptions.lang, x = m && m.weekdays, y = m && m.shortWeekdays, b = r({ a: y ? y[p2] : x[p2].substr(0, 3), A: x[p2], d: d(u2), e: d(u2, 2, " "), w: p2, b: m.shortMonths[g2], B: m.months[g2], m: d(g2 + 1), o: g2 + 1, y: f2.toString().substr(2, 2), Y: f2, H: d(h2), k: h2, I: d(h2 % 12 || 12), l: h2 % 12 || 12, M: d(this.get("Minutes", a2)), p: h2 < 12 ? "AM" : "PM", P: h2 < 12 ? "am" : "pm", S: d(this.get("Seconds", a2)), L: d(Math.floor(i3 % 1e3), 3) }, t2.dateFormats);
            return l(b, function(t3, s2) {
              for (; -1 !== e3.indexOf("%" + s2); )
          ...
          getTimeTicks(t3, e3, i3, o2) {
            let n2, a2, h2, l2;
            let d2 = this, p2 = d2.Date, g2 = [], f2 = {}, m = new p2(e3), x = t3.unitRange, y = t3.count || 1;
            if (o2 = c(o2, 1), s(e3)) {
              d2.set("Milliseconds", m, x >= u.second ? 0 : y * Math.floor(d2.get("Milliseconds", m) / y)), x >= u.second && d2.set("Seconds", m, x >= u.minute ? 0 : y * Math.floor(d2.get("Seconds", m) / y)), x >= u.minute && d2.set("Minutes", m, x >= u.hour ? 0 : y * Math.floor(d2.get("Minutes", m) / y)), x >= u.hour && d2.set("Hours", m, x >= u.day ? 0 : y * Math.floor(d2.get("Hours", m) / y)), x >= u.day && d2.set("Date", m, x >= u.month ? 1 : Math.max(1, y * Math.floor(d2.get("Date", m) / y))), x >= u.month && (d2.set("Month", m, x >= u.year ? 0 : y * Math.floor(d2.get("Month", m) / y)), a2 = d2.get("FullYear", m)), x >= u.year && (a2 -= a2 % y, d2.set("FullYear", m, a2)), x === u.week && (l2 = d2.get("Day", m), d2.set("Date", m, d2.get("Date", m) - l2 + o2 + (l2 < o2 ? -7 : 0))), a2 = d2.get("FullYear", m);
              let t4 = d2.get("Month", m), r2 = d2.get("Date", m), c2 = d2.get("Hours", m);
              e3 = m.getTime(), (d2.variableTimezone || !d2.useUTC) && s(i3) && (h2 = i3 - e3 > 4 * u.month || d2.getTimezoneOffset(e3) !== d2.getTimezoneOffset(i3));
              let p3 = m.getTime();
              for (n2 = 1; p3 < i3; )
                g2.push(p3), x === u.year ? p3 = d2.makeTime(a2 + n2 * y, 0) : x === u.month ? p3 = d2.makeTime(a2, t4 + n2 * y) : h2 && (x === u.day || x === u.week) ? p3 = d2.makeTime(a2, t4, r2 + n2 * y * (x === u.day ? 1 : 7)) : h2 && x === u.hour && y > 1 ? p3 = d2.makeTime(a2, t4, r2, c2 + n2 * y) : p3 += x * y, n2++;
            ...
            if ("object" == typeof e3 && void 0 !== e3.stops)
              ...
              if (!s2)
                for (o2 = r.parsers.length; o2-- && !s2; )
                  (i3 = (n = r.parsers[o2]).regex.exec(e3)) && (s2 = n.parse(i3));
            }
            s2 && (this.rgba = s2);
          }
          get(t3) {
        ...
        return { animate: function(e3, i3, l2) {
          ...
          let o2 = d(e3), r2 = s2 ? [s2] : t3.series, a2 = 0, h2 = 0;
          r2.forEach((t4) => {
            let s3 = d(t4.options.animation);
            a2 = n(e3) && i2(e3.defer) ? o2.defer : Math.max(a2, s3.duration + s3.defer), h2 = Math.min(o2.duration, s3.duration);
          }), t3.renderer.forExport && (a2 = 0);
          let l2 = { defer: Math.max(0, a2 - h2), duration: Math.min(a2, h2) };
          return l2;
        ...
        function u(t3 = "", e3, o2) {
          ...
          for (; null !== (b = n2.exec(t3)); ) {
            ...
            p[s2] && (v.isBlock && s2 === v.fn && S++, v.fn || (v.fn = s2));
            let o3 = "else" === b[1];
        ...
        return (e2 || (e2 = {})).distribute = function t3(e3, n, a) {
          let h = e3, l = h.reducedLen || n, d = (t4, e4) => t4.target - e4.target, c = [], p = e3.length, u = [], g = c.push, f, m, x, y = true, b, v, S = 0, k;
          for (f = p; f--; )
            S += e3[f].size;
          if (S > l) {
            for (r(e3, (t4, e4) => (e4.rank || 0) - (t4.rank || 0)), x = (k = e3[0].rank === e3[e3.length - 1].rank) ? p / 2 : -1, m = k ? x : p - 1; x && S > l; )
              b = e3[f = Math.floor(m)], o(u, f) && (S -= b.size), m += x, k && m >= e3.length && (x /= 2, m = x);
        ...
        let { animate: o, animObject: r, stop: n } = t2, { deg2rad: a, doc: h, noop: l, svg: d, SVG_NS: c, win: p } = i2, { addEvent: u, attr: g, createElement: f, css: m, defined: x, erase: y, extend: b, fireEvent: v, isArray: S, isFunction: k, isObject: M, isString: C, merge: w, objectEach: T, pick: A, pInt: P, syncTimeout: L, uniqueKey: O } = s;
        class D {
          _defaultGetter(t3) {
          ...
          complexColor(t3, i3, s2) {
            ...
            v(this.renderer, "complexColor", { args: arguments }, function() {
              if (t3.radialGradient ? n2 = "radialGradient" : t3.linearGradient && (n2 = "linearGradient"), n2) {
                if (a2 = t3[n2], l2 = o2.gradients, d2 = t3.stops, u2 = s2.radialReference, S(a2) && (t3[n2] = a2 = { x1: a2[0], y1: a2[1], x2: a2[2], y2: a2[3], gradientUnits: "userSpaceOnUse" }), "radialGradient" === n2 && u2 && !x(a2.gradientUnits) && (h2 = a2, a2 = w(a2, o2.getRadialAttr(u2, h2), { gradientUnits: "userSpaceOnUse" })), T(a2, function(t4, e3) {
                  "id" !== e3 && f2.push(e3, t4);
                }), T(d2, function(t4) {
                  f2.push(t4);
                }), l2[f2 = f2.join(",")])
          ...
          getBBox(t3, e3) {
            ...
            if (x(p2) && (-1 === (n2 = p2.toString()).indexOf("<") && (n2 = n2.replace(/[0-9]/g, "0")), n2 += ["", d2.rootFontSize, v2, y2, this.textWidth, h2, c2 && c2.textOverflow, c2 && c2.fontWeight].join(",")), n2 && !t3 && (i3 = u2[n2]), !i3) {
              if (f2 || d2.forExport) {
                try {
                  r2 = this.fakeTS && function(t4) {
                    ...
                    e4 && m(e4, { display: t4 });
                  }, k(r2) && r2("none"), i3 = l2.getBBox ? b({}, l2.getBBox()) : { width: l2.offsetWidth, height: l2.offsetHeight, x: 0, y: 0 }, k(r2) && r2("");
                } catch (t4) {
                }
              ...
              if (s2 = i3.width, o2 = i3.height, f2 && (i3.height = o2 = { "11px,17": 14, "13px,20": 16 }[`${v2 || ""},${Math.round(o2)}`] || o2), y2) {
                let t4 = Number(l2.getAttribute("y") || 0) - i3.y, e4 = { right: 1, center: 0.5 }[h2 || 0] || 0, r3 = y2 * a, n3 = (y2 - 90) * a, d3 = s2 * Math.cos(r3), c3 = s2 * Math.sin(r3), p3 = Math.cos(n3), u3 = Math.sin(n3), g3 = i3.x + e4 * (s2 - d3), f3 = i3.y + t4 - e4 * c3, m2 = g3 + t4 * p3, x2 = m2 + d3, b2 = x2 - o2 * p3, v3 = b2 - d3, S2 = f3 + t4 * u3, k2 = S2 + c3, M2 = k2 - o2 * u3, C2 = M2 - c3;
                i3.x = Math.min(m2, x2, b2, v3), i3.y = Math.min(S2, k2, M2, C2), i3.width = Math.max(m2, x2, b2, v3) - i3.x, i3.height = Math.max(S2, k2, M2, C2) - i3.y;
              }
            }
          ...
          constructor(t3, e3) {
            this.onEvents = {}, this.opacity = 1, this.SVG_NS = c, this.element = "span" === e3 ? f(e3) : h.createElementNS(this.SVG_NS, e3), this.renderer = t3, v(this, "afterInit");
          }
          on(t3, e3) {
          ...
          shadow(t3) {
            var _a;
            let { renderer: e3 } = this, i3 = w(((_a = this.parentGroup) == null ? void 0 : _a.rotation) === 90 ? { offsetX: -1, offsetY: -1 } : {}, M(t3) ? t3 : {}), s2 = e3.shadowDefinition(i3);
          ...
          updateTransform(t3 = "transform") {
            let { element: e3, matrix: i3, rotation: s2 = 0, scaleX: o2, scaleY: r2, translateX: n2 = 0, translateY: a2 = 0 } = this, h2 = ["translate(" + n2 + "," + a2 + ")"];
            x(i3) && h2.push("matrix(" + i3.join(",") + ")"), s2 && h2.push("rotate(" + s2 + " " + A(this.rotationOriginX, e3.getAttribute("x"), 0) + " " + A(this.rotationOriginY, e3.getAttribute("y") || 0) + ")"), (x(o2) || x(r2)) && h2.push("scale(" + A(o2, 1) + " " + A(r2, 1) + ")"), h2.length && !(this.text || this).textPath && e3.setAttribute(t3, h2.join(" "));
          }
        ...
        let l;
        let { charts: d, deg2rad: c, doc: p, isFirefox: u, isMS: g, isWebKit: f, noop: m, SVG_NS: x, symbolSizes: y, win: b } = i2, { addEvent: v, attr: S, createElement: k, css: M, defined: C, destroyObjectProperties: w, extend: T, isArray: A, isNumber: P, isObject: L, isString: O, merge: D, pick: E, pInt: j, uniqueKey: I } = h;
        class B {
          constructor(t3, e3, i3, s2, o2, r2, n2) {
            let a2, h2;
            let l2 = this.createElement("svg").attr({ version: "1.1", class: "highcharts-root" }), d2 = l2.element;
            n2 || l2.css(this.getStyle(s2 || {})), t3.appendChild(d2), S(t3, "dir", "ltr"), -1 === t3.innerHTML.indexOf("xmlns") && S(d2, "xmlns", this.SVG_NS), this.box = d2, this.boxWrapper = l2, this.alignedObjects = [], this.url = this.getReferenceURL();
            let c2 = this.createElement("desc").add();
            c2.element.appendChild(p.createTextNode("Created with Highcharts 11.3.0")), this.defs = this.createElement("defs").add(), this.allowHTML = r2, this.forExport = o2, this.styledMode = n2, this.gradients = {}, this.cache = {}, this.cacheKeys = [], this.imgCount = 0, this.rootFontSize = l2.getStyle("font-size"), this.setSize(e3, i3, false), u && t3.getBoundingClientRect && ((a2 = function() {
          ...
          getReferenceURL() {
            if ((u || f) && p.getElementsByTagName("base").length) {
              if (!C(l)) {
                let e3 = I(), i3 = new t2([{ tagName: "svg", attributes: { width: 8, height: 8 }, children: [{ tagName: "defs", children: [{ tagName: "clipPath", attributes: { id: e3 }, children: [{ tagName: "rect", attributes: { width: 4, height: 4 } }] }] }, { tagName: "rect", attributes: { id: "hitme", width: 8, height: 8, "clip-path": `url(#${e3})`, fill: "rgba(0,0,0,0.001)" } }] }]), s2 = i3.addToDOM(p.body);
          ...
          button(e3, i3, s2, o2, r2 = {}, n2, a2, h2, l2, d2) {
            ...
            return f2.attr(D({ padding: 8, r: 2 }, S2)), m2 || (S2 = D({ fill: "#f7f7f7", stroke: "#cccccc", "stroke-width": 1 }, S2), c2 = (n2 = D(S2, { fill: "#e6e6e6" }, t2.filterUserAttributes(n2 || x2.hover || {}))).style, delete n2.style, p2 = (a2 = D(S2, { fill: "#e6e9ff", style: { color: "#000000", fontWeight: "bold" } }, t2.filterUserAttributes(a2 || x2.select || {}))).style, delete a2.style, u2 = (h2 = D(S2, { style: { color: "#cccccc" } }, t2.filterUserAttributes(h2 || x2.disabled || {}))).style, delete h2.style), v(f2.element, g ? "mouseover" : "mouseenter", function() {
              3 !== y2 && f2.setState(1);
            ...
            if (m2)
              ...
              s3.imgwidth = E(r2 && r2.width, y[h2] && y[h2].width), s3.imgheight = E(r2 && r2.height, y[h2] && y[h2].height), l2 = (t4) => t4.attr({ width: t4.width, height: t4.height }), ["width", "height"].forEach((t4) => {
                s3[`${t4}Setter`] = function(t5, e4) {
                  ...
                  r2 && "within" === r2.backgroundSize && o3 && n3 && a3 && h3 ? (d2 = Math.min(o3 / a3, n3 / h3), S(s4, { width: Math.round(a3 * d2), height: Math.round(h3 * d2) })) : s4 && l3 && s4.setAttribute(e4, l3), !i4 && a3 && h3 && this.translate(((o3 || 0) - a3 * d2) / 2, ((n3 || 0) - h3 * d2) / 2);
                };
              }), C(e3) && s3.attr({ x: e3, y: i3 }), s3.isImg = true, C(s3.imgwidth) && C(s3.imgheight) ? l2(s3) : (s3.attr({ width: 0, height: 0 }), k("img", { onload: function() {
          ...
          fontMetrics(t3) {
            let e3 = j(o.prototype.getStyle.call(t3, "font-size") || 0), i3 = e3 < 24 ? e3 + 3 : Math.round(1.2 * e3), s2 = Math.round(0.8 * i3);
        ...
        return T(B.prototype, { Element: o, SVG_NS: x, escapes: { "&": "&amp;", "<": "&lt;", ">": "&gt;", "'": "&#39;", '"': "&quot;" }, symbols: n, draw: m }), s.registerRendererType("svg", B, true), B;
        ...
        let { composed: s } = t2, { css: o, defined: r, extend: n, pushUnique: a, pInt: h } = i2;
        class l extends e2 {
          static compose(t3) {
            if (a(s, this.compose)) {
          ...
          htmlCss(t3) {
            ...
            return s2 && (delete t3.width, this.textWidth = h(r2) || void 0, e3 = true), (t3 == null ? void 0 : t3.textOverflow) === "ellipsis" && (t3.whiteSpace = "nowrap", t3.overflow = "hidden"), n(this.styles, t3), o(i3, t3), e3 && this.htmlUpdateTransform(), this;
          }
          htmlGetBBox() {
            let { element: t3 } = this;
          ...
          htmlUpdateTransform() {
            ...
            let { element: t3, renderer: e3, rotation: i3, styles: s2, textAlign: n2 = "left", textWidth: a2, translateX: h2 = 0, translateY: l2 = 0, x: d = 0, y: c = 0 } = this, p = { left: 0, center: 0.5, right: 1 }[n2], u = s2 == null ? void 0 : s2.whiteSpace;
            if (o(t3, { marginLeft: `${h2}px`, marginTop: `${l2}px` }), "SPAN" === t3.tagName) {
              let s3 = [i3, n2, t3.innerHTML, a2, this.textAlign].join(","), h3, l3 = false;
              if (a2 !== this.oldTextWidth) {
                let e4 = this.textPxLength ? this.textPxLength : (o(t3, { width: "", whiteSpace: u || "nowrap" }), t3.offsetWidth), s4 = a2 || 0;
                (s4 > this.oldTextWidth || e4 > s4) && (/[ \-]/.test(t3.textContent || t3.innerText) || "ellipsis" === t3.style.textOverflow) && (o(t3, { width: e4 > s4 || i3 ? a2 + "px" : "auto", display: "block", whiteSpace: u || "normal" }), this.oldTextWidth = a2, l3 = true);
              }
              this.hasBoxWidthChanged = l3, s3 !== this.cTT && (h3 = e3.fontMetrics(t3).b, r(i3) && (i3 !== (this.oldRotation || 0) || n2 !== this.oldAlign) && this.setSpanRotation(i3, p, h3), this.getSpanCorrection(!r(i3) && this.textPxLength || t3.offsetWidth, h3, p)), o(t3, { left: d + (this.xCorr || 0) + "px", top: c + (this.yCorr || 0) + "px" }), this.cTT = s3, this.oldRotation = i3, this.oldAlign = n2;
            }
          }
          setSpanRotation(t3, e3, i3) {
            o(this.element, { transform: `rotate(${t3}deg)`, transformOrigin: `${100 * e3}% ${i3}px` });
          }
        }
        return l;
      }), i(e, "Core/Renderer/HTML/HTMLRenderer.js", [e["Core/Renderer/HTML/AST.js"], e["Core/Globals.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Renderer/SVG/SVGRenderer.js"], e["Core/Utilities.js"]], function(t2, e2, i2, s, o) {
        let { composed: r } = e2, { attr: n, createElement: a, extend: h, pick: l, pushUnique: d } = o;
        class c extends s {
          static compose(t3) {
            if (d(r, this.compose)) {
              let e3 = c.prototype, i3 = t3.prototype;
              i3.html = e3.html;
            }
            return t3;
          }
          html(e3, s2, o2) {
            let r2 = this.createElement("span"), d2 = r2.element, c2 = r2.renderer, p = function(t3, e4) {
              ["opacity", "visibility"].forEach(function(s3) {
                t3[s3 + "Setter"] = function(o3, r3, n2) {
                  let a2 = t3.div ? t3.div.style : e4;
                  i2.prototype[s3 + "Setter"].call(this, o3, r3, n2), a2 && (a2[r3] = o3);
                };
              }), t3.addedSetters = true;
            };
            return r2.textSetter = function(e4) {
              e4 !== this.textStr && (delete this.bBox, delete this.oldTextWidth, t2.setElementHTML(this.element, l(e4, "")), this.textStr = e4, r2.doTransform = true);
            }, p(r2, r2.element.style), r2.xSetter = r2.ySetter = r2.alignSetter = r2.rotationSetter = function(t3, e4) {
              "align" === e4 ? r2.alignValue = r2.textAlign = t3 : r2[e4] = t3, r2.doTransform = true;
            }, r2.afterSetters = function() {
              this.doTransform && (this.htmlUpdateTransform(), this.doTransform = false);
            }, r2.attr({ text: e3, x: Math.round(s2), y: Math.round(o2) }).css({ position: "absolute" }), c2.styledMode || r2.css({ fontFamily: this.style.fontFamily, fontSize: this.style.fontSize }), d2.style.whiteSpace = "nowrap", r2.css = r2.htmlCss, r2.add = function(t3) {
              let e4, i3;
              let s3 = c2.box.parentNode, o3 = [];
              if (this.parentGroup = t3, t3) {
                if (!(e4 = t3.div)) {
                  for (i3 = t3; i3; )
                    o3.push(i3), i3 = i3.parentGroup;
                  o3.reverse().forEach(function(t4) {
                    var i4;
                    let l2 = n(t4.element, "class"), d3 = t4.css;
                    function c3(e5, i5) {
                      t4[i5] = e5, "translateX" === i5 ? g.left = e5 + "px" : g.top = e5 + "px", t4.doTransform = true;
                    }
                    let u = t4.styles || {};
                    e4 = t4.div = t4.div || a("div", l2 ? { className: l2 } : void 0, { position: "absolute", left: (t4.translateX || 0) + "px", top: (t4.translateY || 0) + "px", display: t4.display, opacity: t4.opacity, visibility: t4.visibility }, e4 || s3);
                    let g = e4.style;
                    h(t4, { classSetter: (i4 = e4, function(t5) {
                      this.element.setAttribute("class", t5), i4.className = t5;
                    }), css: function(e5) {
                      return d3.call(t4, e5), ["cursor", "pointerEvents"].forEach((t5) => {
                        e5[t5] && (g[t5] = e5[t5]);
                      }), t4;
                    }, on: function() {
                      return o3[0].div && r2.on.apply({ element: o3[0].div, onEvents: t4.onEvents }, arguments), t4;
                    }, translateXSetter: c3, translateYSetter: c3 }), t4.addedSetters || p(t4), t4.css(u);
                  });
                }
              } else
                e4 = s3;
              return e4.appendChild(d2), r2.added = true, r2.alignOnAdd && r2.htmlUpdateTransform(), r2;
            }, r2;
          }
        }
        return c;
        ...
        return class {
          ...
          addLabel() {
            let e3 = this, i3 = e3.axis, s2 = i3.options, o2 = i3.chart, a2 = i3.categories, c2 = i3.logarithmic, p2 = i3.names, g = e3.pos, f = u(e3.options && e3.options.labels, s2.labels), m = i3.tickPositions, x = g === m[0], y = g === m[m.length - 1], b = (!f.step || 1 === f.step) && 1 === i3.tickInterval, v = m.info, S = e3.label, k, M, C, w = this.parameters.category || (a2 ? u(a2[g], p2[g], g) : g);
            c2 && d(w) && (w = r(c2.lin2log(w))), i3.dateTime && (v ? k = (M = o2.time.resolveDTLFormat(s2.dateTimeLabelFormats[!s2.grid && v.higherRanks[g] || v.unitName])).main : d(w) && (k = i3.dateTime.getXDateFormat(w, s2.dateTimeLabelFormats || {}))), e3.isFirst = x, e3.isLast = y;
            let T = { axis: i3, chart: o2, dateTimeLabelFormat: k, isFirst: x, isLast: y, pos: g, tick: e3, tickPositionInfo: v, value: w };
            ...
            L ? e3.shortenLabel = function() {
              for (C = 0; C < L.length; C++)
                if (h(T, { dateTimeLabelFormat: L[C] }), S.attr({ text: A.call(T, T) }), S.getBBox().width < i3.getSlotWidth(e3) - 2 * f.padding)
                  return;
              S.attr({ text: "" });
          ...
          createLabel(t3, e3, i3) {
            let s2 = this.axis, o2 = s2.chart, r2 = n(t3) && e3.enabled ? o2.renderer.text(t3, i3 == null ? void 0 : i3.x, i3 == null ? void 0 : i3.y, e3.useHTML).add(s2.labelGroup) : void 0;
          ...
          moveLabel(t3, e3) {
            ...
            }), !r2 && (i3.labelPos || s2) && (n2 = i3.labelPos || s2.xy, i3.movedLabel = i3.createLabel(t3, e3, n2), i3.movedLabel && i3.movedLabel.attr({ opacity: 0 }));
          }
          render(t3, e3, i3) {
        ...
        let { animObject: h } = t2, { xAxis: l, yAxis: d } = e2, { defaultOptions: c } = s, { registerEventOptions: p } = o, { deg2rad: u } = r, { arrayMax: g, arrayMin: f, clamp: m, correctFloat: x, defined: y, destroyObjectProperties: b, erase: v, error: S, extend: k, fireEvent: M, getClosestDistance: C, insertItem: w, isArray: T, isNumber: A, isString: P, merge: L, normalizeTickInterval: O, objectEach: D, pick: E, relativeLength: j, removeEvent: I, splat: B, syncTimeout: R } = a, z = (t3, e3) => O(e3, void 0, void 0, E(t3.options.allowDecimals, e3 < 0.5 || void 0 !== t3.tickAmount), !!t3.tickAmount);
        ...
        class N {
          ...
          init(t3, e3, i3 = this.coll) {
            ...
            this.userOptions = e3, this.minPixelPadding = 0, this.reversed = E(r2.reversed, this.reversed), this.visible = r2.visible, this.zoomEnabled = r2.zoomEnabled, this.hasNames = "category" === a2 || true === r2.categories, this.categories = T(r2.categories) && r2.categories || (this.hasNames ? [] : void 0), this.names || (this.names = [], this.names.keys = {}), this.plotLinesAndBandsGroups = {}, this.positiveValuesOnly = !!this.logarithmic, this.isLinked = y(r2.linkedTo), this.ticks = {}, this.labelEdge = [], this.minorTicks = {}, this.plotLinesAndBands = [], this.alternateBands = {}, this.len = 0, this.minRange = this.userMinRange = r2.minRange || r2.maxZoom, this.range = r2.range, this.offset = r2.offset || 0, this.max = void 0, this.min = void 0;
            let h2 = E(r2.crosshair, B(t3.options.tooltip.crosshairs)[s2 ? 0 : 1]);
            this.crosshair = true === h2 ? {} : h2, -1 === t3.axes.indexOf(this) && (s2 ? t3.axes.splice(t3.xAxis.length, 0, this) : t3.axes.push(this), w(this, t3[this.coll])), t3.orderItems(this.coll), this.series = this.series || [], t3.inverted && !this.isZAxis && s2 && !y(this.reversed) && (this.reversed = true), this.labelRotation = A(n2.rotation) ? n2.rotation : void 0, p(this, r2), M(this, "afterInit");
          }
          setOptions(t3) {
            let e3 = this.horiz ? { labels: { autoRotation: [-45] }, margin: 15 } : { title: { rotation: 90 * this.side } };
            this.options = L(e3, c[this.coll], t3), M(this, "afterSetOptions", { userOptions: t3 });
          }
          defaultLabelFormatter(t3) {
            let e3 = this.axis, i3 = this.chart, { numberFormatter: s2 } = i3, o2 = A(this.value) ? this.value : NaN, r2 = e3.chart.time, n2 = e3.categories, a2 = this.dateTimeLabelFormat, h2 = c.lang, l2 = h2.numericSymbols, d2 = h2.numericSymbolMagnitude || 1e3, p2 = e3.logarithmic ? Math.abs(o2) : e3.tickInterval, u2 = l2 && l2.length, g2, f2;
            if (n2)
              f2 = `${this.value}`;
            else if (a2)
              f2 = r2.dateFormat(a2, o2);
            else if (u2 && l2 && p2 >= 1e3)
              for (; u2-- && void 0 === f2; )
                p2 >= (g2 = Math.pow(d2, u2 + 1)) && 10 * o2 % g2 == 0 && null !== l2[u2] && 0 !== o2 && (f2 = s2(o2 / g2, -1) + l2[u2]);
              ...
              e3.hasVisibleSeries = false, e3.dataMin = e3.dataMax = e3.threshold = void 0, e3.softThreshold = !e3.isXAxis, e3.series.forEach((i3) => {
                if (i3.reserveSpace()) {
                  ...
                  if (e3.hasVisibleSeries = true, e3.positiveValuesOnly && 0 >= (r2 || 0) && (r2 = void 0), e3.isXAxis)
                    (o2 = i3.xData) && o2.length && (o2 = e3.logarithmic ? o2.filter((t4) => t4 > 0) : o2, n2 = (t3 = i3.getXExtremes(o2)).min, a2 = t3.max, A(n2) || n2 instanceof Date || (o2 = o2.filter(A), n2 = (t3 = i3.getXExtremes(o2)).min, a2 = t3.max), o2.length && (e3.dataMin = Math.min(E(e3.dataMin, n2), n2), e3.dataMax = Math.max(E(e3.dataMax, a2), a2)));
                  else {
                    let t4 = i3.applyExtremes();
                    A(t4.dataMin) && (n2 = t4.dataMin, e3.dataMin = Math.min(E(e3.dataMin, n2), n2)), A(t4.dataMax) && (a2 = t4.dataMax, e3.dataMax = Math.max(E(e3.dataMax, a2), a2)), y(r2) && (e3.threshold = r2), (!s2.softThreshold || e3.positiveValuesOnly) && (e3.softThreshold = false);
                  }
                }
              });
          ...
          translate(t3, e3, i3, s2, o2, r2) {
            ...
            if (!A(a2))
              return NaN;
            let h2 = n2.minPixelPadding, l2 = (n2.isOrdinal || ((_a = n2.brokenAxis) == null ? void 0 : _a.hasBreaks) || n2.logarithmic && o2) && n2.lin2val, d2 = 1, c2 = 0, p2 = s2 && n2.old ? n2.old.transA : n2.transA, u2 = 0;
            if (p2 || (p2 = n2.transA), i3 && (d2 *= -1, c2 = n2.len), n2.reversed && (d2 *= -1, c2 -= d2 * (n2.sector || n2.len)), e3)
              ...
              l2 && (t3 = n2.val2lin(t3));
              let e4 = d2 * (t3 - a2) * p2;
              u2 = (n2.isRadial ? e4 : x(e4)) + c2 + d2 * h2 + (A(r2) ? p2 * r2 : 0);
            }
            return u2;
          }
          toPixels(t3, e3) {
          ...
          getPlotLinePath(t3) {
            let e3 = this, i3 = e3.chart, s2 = e3.left, o2 = e3.top, r2 = t3.old, n2 = t3.value, a2 = t3.lineWidth, h2 = r2 && i3.oldChartHeight || i3.chartHeight, l2 = r2 && i3.oldChartWidth || i3.chartWidth, d2 = e3.transB, c2 = t3.translatedValue, p2 = t3.force, u2, g2, f2, x2, y2;
            ...
            return M(this, "getPlotLinePath", v2, function(t4) {
              u2 = f2 = Math.round((c2 = m(c2 = E(c2, e3.translate(n2, void 0, void 0, r2)), -1e5, 1e5)) + d2), g2 = x2 = Math.round(h2 - c2 - d2), A(c2) ? e3.horiz ? (g2 = o2, x2 = h2 - e3.bottom, u2 = f2 = b2(u2, s2, s2 + e3.width)) : (u2 = s2, f2 = l2 - e3.right, g2 = x2 = b2(g2, o2, o2 + e3.height)) : (y2 = true, p2 = false), t4.path = y2 && !p2 ? void 0 : i3.renderer.crispLine([["M", u2, g2], ["L", f2, x2]], a2 || 1);
            }), v2.path;
          }
          getLinearTickPositions(t3, e3, i3) {
            let s2, o2, r2;
            let n2 = x(Math.floor(e3 / t3) * t3), a2 = x(Math.ceil(i3 / t3) * t3), h2 = [];
            if (x(n2 + t3) === n2 && (r2 = 20), this.single)
              return [e3];
            for (s2 = n2; s2 <= a2 && (h2.push(s2), (s2 = x(s2 + t3, r2)) !== o2); )
              o2 = s2;
            return h2;
          }
          ...
          getMinorTickPositions() {
            let t3 = this.options, e3 = this.tickPositions, i3 = this.minorTickInterval, s2 = this.pointRangePadding || 0, o2 = (this.min || 0) - s2, r2 = (this.max || 0) + s2, n2 = r2 - o2, a2 = [], h2;
          ...
          adjustForMinRange() {
            let t3 = this.options, e3 = this.logarithmic, { max: i3, min: s2, minRange: o2 } = this, r2, n2, a2, h2;
            ...
            })) || 0), this.dataMax - this.dataMin)), A(i3) && A(s2) && A(o2) && i3 - s2 < o2 && (n2 = this.dataMax - this.dataMin >= o2, r2 = (o2 - i3 + s2) / 2, a2 = [s2 - r2, E(t3.min, s2 - r2)], n2 && (a2[2] = e3 ? e3.log2lin(this.dataMin) : this.dataMin), h2 = [(s2 = g(a2)) + o2, E(t3.max, s2 + o2)], n2 && (h2[2] = e3 ? e3.log2lin(this.dataMax) : this.dataMax), (i3 = f(h2)) - s2 < o2 && (a2[0] = i3 - o2, a2[1] = E(t3.min, i3 - o2), s2 = g(a2))), this.minRange = o2, this.min = s2, this.max = i3;
          }
          getClosest() {
            let t3, e3;
            if (this.categories)
          ...
          nameToX(t3) {
            let e3 = T(this.options.categories), i3 = e3 ? this.categories : this.names, s2 = t3.options.x, o2;
          ...
          updateNames() {
            ...
            i3 > 0 && (Object.keys(e3.keys).forEach(function(t4) {
              ...
              e4.xIncrement = null, (!e4.points || e4.isDirtyData) && (t3.max = Math.max(t3.max, e4.xData.length - 1), e4.processData(), e4.generatePoints()), e4.data.forEach(function(i4, s2) {
                let o2;
                (i4 == null ? void 0 : i4.options) && void 0 !== i4.name && void 0 !== (o2 = t3.nameToX(i4)) && o2 !== i4.x && (i4.x = o2, e4.xData[s2] = o2);
              });
            }));
          }
          setAxisTranslation() {
          ...
          setTickInterval(t3) {
            var _a, _b, _c, _d;
            let { categories: e3, chart: i3, dataMax: s2, dataMin: o2, dateTime: r2, isXAxis: n2, logarithmic: a2, options: h2, softThreshold: l2 } = this, d2 = A(this.threshold) ? this.threshold : void 0, c2 = this.minRange || 0, { ceiling: p2, floor: u2, linkedTo: g2, softMax: f2, softMin: m2 } = h2, b2 = A(g2) && ((_a = i3[this.coll]) == null ? void 0 : _a[g2]), v2 = h2.tickPixelInterval, k2 = h2.maxPadding, C2 = h2.minPadding, w2 = 0, T2, P2 = A(h2.tickInterval) && h2.tickInterval >= 0 ? h2.tickInterval : void 0, L2, O2, D2, j2;
            if (r2 || e3 || b2 || this.getTickAmount(), D2 = E(this.userMin, h2.min), j2 = E(this.userMax, h2.max), b2 ? (this.linkedParent = b2, T2 = b2.getExtremes(), this.min = E(T2.min, T2.dataMin), this.max = E(T2.max, T2.dataMax), h2.type !== b2.options.type && S(11, true, i3)) : (l2 && y(d2) && A(s2) && A(o2) && (o2 >= d2 ? (L2 = d2, C2 = 0) : s2 <= d2 && (O2 = d2, k2 = 0)), this.min = E(D2, L2, o2), this.max = E(j2, O2, s2)), A(this.max) && A(this.min) && (a2 && (this.positiveValuesOnly && !t3 && 0 >= Math.min(this.min, E(o2, this.min)) && S(10, true, i3), this.min = x(a2.log2lin(this.min), 16), this.max = x(a2.log2lin(this.max), 16)), this.range && A(o2) && (this.userMin = this.min = D2 = Math.max(o2, this.minFromRange() || 0), this.userMax = j2 = this.max, this.range = void 0)), M(this, "foundExtremes"), this.adjustForMinRange(), A(this.min) && A(this.max)) {
              if (!A(this.userMin) && A(m2) && m2 < this.min && (this.min = D2 = m2), !A(this.userMax) && A(f2) && f2 > this.max && (this.max = j2 = f2), e3 || this.axisPointRange || ((_b = this.stacking) == null ? void 0 : _b.usePercentage) || b2 || !(w2 = this.max - this.min) || (!y(D2) && C2 && (this.min -= w2 * C2), y(j2) || !k2 || (this.max += w2 * k2)), !A(this.userMin) && A(u2) && (this.min = Math.max(this.min, u2)), !A(this.userMax) && A(p2) && (this.max = Math.min(this.max, p2)), l2 && A(o2) && A(s2)) {
                let t4 = d2 || 0;
                !y(D2) && this.min < t4 && o2 >= t4 ? this.min = h2.minRange ? Math.min(t4, this.max - c2) : t4 : !y(j2) && this.max > t4 && s2 <= t4 && (this.max = h2.minRange ? Math.max(t4, this.min + c2) : t4);
              }
            ...
            let I2 = E(h2.minTickInterval, r2 && !this.series.some((t4) => t4.noSharedTooltip) ? this.closestPointRange : 0);
            !P2 && this.tickInterval < I2 && (this.tickInterval = I2), r2 || a2 || P2 || (this.tickInterval = z(this, this.tickInterval)), this.tickAmount || (this.tickInterval = this.unsquish()), this.setTickPositions();
          }
          setTickPositions() {
            var _a, _b;
            ...
            if (this.tickmarkOffset = this.categories && "between" === t3.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0, this.minorTickInterval = "auto" === s2 && this.tickInterval ? this.tickInterval / t3.minorTicksPerMajor : s2, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || false !== t3.allowDecimals), e3)
              ...
              if (!((_a = this.ordinal) == null ? void 0 : _a.positions) && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                h2 = [this.min, this.max], S(19, false, this.chart);
              else if (this.dateTime)
                h2 = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t3.units), this.min, this.max, t3.startOfWeek, (_b = this.ordinal) == null ? void 0 : _b.positions, this.closestPointRange, true);
            ...
            this.tickPositions = h2, this.paddedTicks = h2.slice(0), this.trimTicks(h2, n2, a2), !this.isLinked && A(this.min) && A(this.max) && (this.single && h2.length < 2 && !this.categories && !this.series.some((t4) => t4.is("heatmap") && "between" === t4.options.pointPlacement) && (this.min -= 0.5, this.max += 0.5), e3 || l2 || this.adjustTickAmount()), M(this, "afterSetTickPositions");
          }
          trimTicks(t3, e3, i3) {
          ...
          alignToOthers() {
            let t3;
            let e3 = this, i3 = [this], s2 = e3.options, o2 = this.chart.options.chart, r2 = "yAxis" === this.coll && o2.alignThresholds, n2 = [];
            if (e3.thresholdAlignment = void 0, (false !== o2.alignTicks && s2.alignTicks || r2) && false !== s2.startOnTick && false !== s2.endOnTick && !e3.logarithmic) {
              let s3 = (t4) => {
              ...
              this.chart[this.coll].forEach(function(r3) {
                let { series: n3 } = r3;
                n3.length && n3.some((t4) => t4.visible) && r3 !== e3 && s3(r3) === o3 && (t3 = true, i3.push(r3));
              });
            }
            if (t3 && r2) {
              i3.forEach((t5) => {
          ...
          adjustTickAmount() {
            let t3 = this, { finalTickAmt: e3, max: i3, min: s2, options: o2, tickPositions: r2, tickAmount: n2, thresholdAlignment: a2 } = t3, h2 = r2 == null ? void 0 : r2.length, l2 = E(t3.threshold, t3.softThreshold ? 0 : null), d2, c2, p2 = t3.tickInterval, u2, g2 = () => r2.push(x(r2[r2.length - 1] + p2)), f2 = () => r2.unshift(x(r2[0] - p2));
            if (A(a2) && (u2 = a2 < 0.5 ? Math.ceil(a2 * (n2 - 1)) : Math.floor(a2 * (n2 - 1)), o2.reversed && (u2 = n2 - 1 - u2)), t3.hasData() && A(s2) && A(i3)) {
              let a3 = () => {
          ...
          setScale() {
            ...
            o2 || i3 || s2 || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (e3 && "yAxis" === t3 && e3.buildStacks(), this.forceRedraw = false, this.userMinRange || (this.minRange = void 0), this.getSeriesExtremes(), this.setTickInterval(), e3 && "xAxis" === t3 && e3.buildStacks(), this.isDirty || (this.isDirty = o2 || this.min !== ((_a = this.old) == null ? void 0 : _a.min) || this.max !== ((_b = this.old) == null ? void 0 : _b.max))) : e3 && e3.cleanStacks(), i3 && this.panningState && (this.panningState.isDirty = true), M(this, "afterSetScale");
          }
          setExtremes(t3, e3, i3 = true, s2, o2) {
            let r2 = this, n2 = r2.chart;
            r2.series.forEach((t4) => {
              delete t4.kdTree;
            }), M(r2, "setExtremes", o2 = k(o2, { min: t3, max: e3 }), () => {
              r2.userMin = t3, r2.userMax = e3, r2.eventArgs = o2, i3 && n2.redraw(s2);
            });
          }
          zoom(t3, e3) {
            let i3 = this, s2 = this.dataMin, o2 = this.dataMax, r2 = this.options, n2 = Math.min(s2, E(r2.min, s2)), a2 = Math.max(o2, E(r2.max, o2)), h2 = { newMin: t3, newMax: e3 };
            return M(this, "zoom", h2, function(t4) {
              let e4 = t4.newMin, r3 = t4.newMax;
              (e4 !== i3.min || r3 !== i3.max) && (!i3.allowZoomOutside && (y(s2) && (e4 < n2 && (e4 = n2), e4 > a2 && (e4 = a2)), y(o2) && (r3 < n2 && (r3 = n2), r3 > a2 && (r3 = a2))), i3.displayBtn = void 0 !== e4 || void 0 !== r3, i3.setExtremes(e4, r3, false, void 0, { trigger: "zoom" })), t4.zoomed = true;
            }), h2.zoomed;
          }
          setAxisSize() {
            let t3 = this.chart, e3 = this.options, i3 = e3.offsets || [0, 0, 0, 0], s2 = this.horiz, o2 = this.width = Math.round(j(E(e3.width, t3.plotWidth - i3[3] + i3[1]), t3.plotWidth)), r2 = this.height = Math.round(j(E(e3.height, t3.plotHeight - i3[0] + i3[2]), t3.plotHeight)), n2 = this.top = Math.round(j(E(e3.top, t3.plotTop + i3[0]), t3.plotHeight, t3.plotTop)), a2 = this.left = Math.round(j(E(e3.left, t3.plotLeft + i3[3]), t3.plotWidth, t3.plotLeft));
          ...
          unsquish() {
            let t3 = this.options.labels, e3 = this.horiz, i3 = this.tickInterval, s2 = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / i3), o2 = t3.rotation, r2 = this.labelMetrics().h, n2 = Math.max(this.max - this.min, 0), a2 = function(t4) {
              let e4 = t4 / (s2 || 1);
              return (e4 = e4 > 1 ? Math.ceil(e4) : 1) * i3 > n2 && t4 !== 1 / 0 && s2 !== 1 / 0 && n2 && (e4 = Math.ceil(n2 / i3)), x(e4 * i3);
            }, h2 = i3, l2, d2 = Number.MAX_VALUE, c2;
            if (e3) {
              if (!t3.staggerLines && (A(o2) ? c2 = [o2] : s2 < t3.autoRotationLimit && (c2 = t3.autoRotation)), c2) {
                let t4, e4;
                for (let i4 of c2)
                  (i4 === o2 || i4 && i4 >= -90 && i4 <= 90) && (e4 = (t4 = a2(Math.abs(r2 / Math.sin(u * i4)))) + Math.abs(i4 / 360)) < d2 && (d2 = e4, l2 = i4, h2 = t4);
              }
            } else
              h2 = a2(0.75 * r2);
            return this.autoRotation = c2, this.labelRotation = E(l2, A(o2) ? o2 : 0), t3.step ? i3 : h2;
          }
          getSlotWidth(t3) {
          ...
          renderUnsquish() {
            ...
            if (P(o2.rotation) || (l2.rotation = o2.rotation || 0), i3.forEach(function(t4) {
              let e4 = s2[t4];
          ...
          addTitle(t3) {
            ...
            this.axisTitle || ((e3 = n2.textAlign) || (e3 = (s2 ? { low: "left", middle: "center", high: "right" } : { low: o2 ? "right" : "left", middle: "center", high: o2 ? "left" : "right" })[n2.align]), this.axisTitle = i3.text(n2.text || "", 0, 0, n2.useHTML).attr({ zIndex: 7, rotation: n2.rotation || 0, align: e3 }).addClass("highcharts-axis-title"), a2 || this.axisTitle.css(L(n2.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = true), a2 || n2.style.width || this.isRadial || this.axisTitle.css({ width: this.len + "px" }), this.axisTitle[t3 ? "show" : "hide"](t3);
          }
          generateTick(t3) {
            let e3 = this.ticks;
          ...
          createGroups() {
            let { axisParent: t3, chart: e3, coll: i3, options: s2 } = this, o2 = e3.renderer, r2 = (e4, r3, n2) => o2.g(e4).attr({ zIndex: n2 }).addClass(`highcharts-${i3.toLowerCase()}${r3} ` + (this.isRadial ? `highcharts-radial-axis${r3} ` : "") + (s2.className || "")).add(t3);
          ...
          getOffset() {
            let t3 = this, { chart: e3, horiz: i3, options: s2, side: o2, ticks: r2, tickPositions: n2, coll: a2 } = t3, h2 = e3.inverted && !t3.isZAxis ? [1, 0, 3, 2][o2] : o2, l2 = t3.hasData(), d2 = s2.title, c2 = s2.labels, p2 = A(s2.crossing), u2 = e3.axisOffset, g2 = e3.clipOffset, f2 = [-1, 1, 1, -1][o2], m2, x2 = 0, b2, v2 = 0, S2 = 0, k2, C2;
            if (t3.showAxis = m2 = l2 || s2.showEmpty, t3.staggerLines = t3.horiz && c2.staggerLines || void 0, t3.createGroups(), l2 || t3.isLinked ? (n2.forEach(function(e4) {
              t3.generateTick(e4);
            }), t3.renderUnsquish(), t3.reserveSpaceDefault = 0 === o2 || 2 === o2 || { 1: "left", 3: "right" }[o2] === t3.labelAlign, E(c2.reserveSpace, !p2 && null, "center" === t3.labelAlign || null, t3.reserveSpaceDefault) && n2.forEach(function(t4) {
          ...
          destroy(t3) {
            ...
            if (M(this, "destroy", { keepEvents: t3 }), t3 || I(e3), [e3.ticks, e3.minorTicks, e3.alternateBands].forEach(function(t4) {
              b(t4);
            }), i3) {
              let t4 = i3.length;
              for (; t4--; )
          ...
          drawCrosshair(t3, e3) {
            let s2 = this.crosshair, o2 = E(s2 && s2.snap, true), r2 = this.chart, n2, a2, h2, l2 = this.cross, d2;
            if (M(this, "drawCrosshair", { e: t3, point: e3 }), t3 || (t3 = this.cross && this.cross.e), s2 && false !== (y(e3) || !o2)) {
              if (o2 ? y(e3) && (a2 = E("colorAxis" !== this.coll ? e3.crosshairPos : null, this.isXAxis ? e3.plotX : this.len - e3.plotY)) : a2 = t3 && (this.horiz ? t3.chartX - this.pos : this.len - t3.chartY + this.pos), y(a2) && (d2 = { value: e3 && (this.isXAxis ? e3.x : E(e3.stackY, e3.y)), translatedValue: a2 }, r2.polar && k(d2, { isCrosshair: true, chartX: t3 && t3.chartX, chartY: t3 && t3.chartY, point: e3 }), n2 = this.getPlotLinePath(d2) || null), !y(n2)) {
                this.hideCrosshair();
                return;
              }
              h2 = this.categories && !this.isRadial, l2 || (this.cross = l2 = r2.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (h2 ? "category " : "thin ") + (s2.className || "")).attr({ zIndex: E(s2.zIndex, 2) }).add(), !r2.styledMode && (l2.attr({ stroke: s2.color || (h2 ? i2.parse("#ccd3ff").setOpacity(0.25).get() : "#cccccc"), "stroke-width": E(s2.width, 1) }).css({ "pointer-events": "none" }), s2.dashStyle && l2.attr({ dashstyle: s2.dashStyle }))), l2.show().attr({ d: n2 }), h2 && !s2.width && l2.attr({ "stroke-width": this.transA }), this.cross.e = t3;
            } else
              this.hideCrosshair();
      ...
      }), i(e, "Core/Axis/DateTimeAxis.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function(t2, e2) {
        var i2;
        let { composed: s } = t2, { addEvent: o, getMagnitude: r, normalizeTickInterval: n, pushUnique: a, timeUnits: h } = e2;
        return function(t3) {
          function e3() {
          ...
          t3.compose = function t4(r2) {
            if (a(s, t4)) {
              r2.keepProps.push("dateTime");
              let t5 = r2.prototype;
              t5.getTimeTicks = e3, o(r2, "afterSetOptions", i3);
            }
            return r2;
          };
          class l {
            ...
            normalizeTimeTickInterval(t4, e4) {
              let i4 = e4 || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], s2 = i4[i4.length - 1], o2 = h[s2[0]], a2 = s2[1], l2;
              for (l2 = 0; l2 < i4.length; l2++)
                if (o2 = h[(s2 = i4[l2])[0]], a2 = s2[1], i4[l2 + 1]) {
                  let e5 = (o2 * a2[a2.length - 1] + h[i4[l2 + 1][0]]) / 2;
                  if (t4 <= e5)
                    break;
                }
              o2 === h.year && t4 < 5 * o2 && (a2 = [1, 2, 5]);
              let d = n(t4 / o2, a2, "year" === s2[0] ? Math.max(r(t4 / o2), 1) : 1);
              return { unitRange: o2, count: d, unitName: s2[0] };
            }
            getXDateFormat(t4, e4) {
              let { axis: i4 } = this, s2 = i4.chart.time;
              return i4.closestPointRange ? s2.getDateFormat(i4.closestPointRange, t4, i4.options.startOfWeek, e4) || s2.resolveDTLFormat(e4.year).main : s2.resolveDTLFormat(e4.day).main;
            }
          }
          t3.Additions = l;
        }(i2 || (i2 = {})), i2;
      }), i(e, "Core/Axis/LogarithmicAxis.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function(t2, e2) {
        var i2;
        let { composed: s } = t2, { addEvent: o, normalizeTickInterval: r, pick: n, pushUnique: a } = e2;
        return function(t3) {
          function e3(t4) {
            let e4 = t4.userOptions, i4 = this.logarithmic;
            "logarithmic" !== e4.type ? this.logarithmic = void 0 : i4 || (i4 = this.logarithmic = new h(this));
          }
          function i3() {
          ...
          t3.compose = function t4(r2) {
            return a(s, t4) && (r2.keepProps.push("logarithmic"), o(r2, "init", e3), o(r2, "afterInit", i3)), r2;
          };
          class h {
            constructor(t4) {
              this.axis = t4;
            }
            getLogTickPositions(t4, e4, i4, s2) {
              let o2 = this.axis, a2 = o2.len, h2 = o2.options, l = [];
              if (s2 || (this.minorAutoInterval = void 0), t4 >= 0.5)
                t4 = Math.round(t4), l = o2.getLinearTickPositions(t4, e4, i4);
              else if (t4 >= 0.08) {
                let o3, r2, n2, a3, h3, d, c;
                let p = Math.floor(e4);
                for (o3 = t4 > 0.3 ? [1, 2, 4] : t4 > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], r2 = p; r2 < i4 + 1 && !c; r2++)
                  for (n2 = 0, a3 = o3.length; n2 < a3 && !c; n2++)
                    (h3 = this.log2lin(this.lin2log(r2) * o3[n2])) > e4 && (!s2 || d <= i4) && void 0 !== d && l.push(d), d > i4 && (c = true), d = h3;
              } else {
                let d = this.lin2log(e4), c = this.lin2log(i4), p = s2 ? o2.getMinorTickInterval() : h2.tickInterval, u = "auto" === p ? null : p, g = h2.tickPixelInterval / (s2 ? 5 : 1), f = s2 ? a2 / o2.tickPositions.length : a2;
                t4 = r(t4 = n(u, this.minorAutoInterval, (c - d) * g / (f || 1))), l = o2.getLinearTickPositions(t4, d, c).map(this.log2lin), s2 || (this.minorAutoInterval = t4 / 5);
              }
              return s2 || (o2.tickInterval = t4), l;
            }
            lin2log(t4) {
      ...
      }), i(e, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function(t2, e2) {
        var i2;
        let { composed: s } = t2, { erase: o, extend: r, isNumber: n, pushUnique: a } = e2;
        return function(t3) {
          let e3;
          function i3(t4) {
          ...
          function d(t4, e4, i4) {
            i4 = i4 || this.options;
            let s2 = this.getPlotLinePath({ value: e4, force: true, acrossPanes: i4.acrossPanes }), o2 = [], r2 = this.horiz, a2 = !n(this.min) || !n(this.max) || t4 < this.min && e4 < this.min || t4 > this.max && e4 > this.max, h2 = this.getPlotLinePath({ value: t4, force: true, acrossPanes: i4.acrossPanes }), l2, d2 = 1, c2;
            if (h2 && s2)
              for (a2 && (c2 = h2.toString() === s2.toString(), d2 = 0), l2 = 0; l2 < h2.length; l2 += 2) {
                let t5 = h2[l2], e5 = h2[l2 + 1], i5 = s2[l2], n2 = s2[l2 + 1];
                ("M" === t5[0] || "L" === t5[0]) && ("M" === e5[0] || "L" === e5[0]) && ("M" === i5[0] || "L" === i5[0]) && ("M" === n2[0] || "L" === n2[0]) && (r2 && i5[1] === t5[1] ? (i5[1] += d2, n2[1] += d2) : r2 || i5[2] !== t5[2] || (i5[2] += d2, n2[2] += d2), o2.push(["M", t5[1], t5[2]], ["L", e5[1], e5[2]], ["L", n2[1], n2[2]], ["L", i5[1], i5[2]], ["Z"])), o2.isFlat = c2;
              }
            return o2;
          }
          function c(t4) {
          ...
          function p(t4) {
            let e4 = this.plotLinesAndBands, i4 = this.options, s2 = this.userOptions;
            if (e4) {
              let r2 = e4.length;
              for (; r2--; )
                e4[r2].id === t4 && e4[r2].destroy();
              [i4.plotLines || [], s2.plotLines || [], i4.plotBands || [], s2.plotBands || []].forEach(function(e5) {
                for (r2 = e5.length; r2--; )
                  (e5[r2] || {}).id === t4 && o(e5, e5[r2]);
              });
            }
          }
          function u(t4) {
          ...
          t3.compose = function t4(o2, n2) {
            return a(s, t4) && (e3 = o2, r(n2.prototype, { addPlotBand: i3, addPlotLine: l, addPlotBandOrLine: h, getPlotBandPath: d, removePlotBand: c, removePlotLine: u, removePlotBandOrLine: p })), n2;
          };
        }(i2 || (i2 = {})), i2;
        ...
        class c {
          ...
          render() {
            a(this, "render");
            let { axis: t3, options: e3 } = this, { horiz: i3, logarithmic: s2 } = t3, { color: r2, events: n2, zIndex: c2 = 0 } = e3, p = {}, u = t3.chart.renderer, g = e3.to, f = e3.from, m = e3.value, x = e3.borderWidth, y = e3.label, { label: b, svgElem: v } = this, S = [], k, M = o(f) && o(g), C = o(m), w = !v, T = { class: "highcharts-plot-" + (M ? "band " : "line ") + (e3.className || "") }, A = M ? "bands" : "lines";
            if (!t3.chart.styledMode && (C ? (T.stroke = r2 || "#999999", T["stroke-width"] = d(e3.width, 1), e3.dashStyle && (T.dashstyle = e3.dashStyle)) : M && (T.fill = r2 || "#e6e9ff", x && (T.stroke = e3.borderColor, T["stroke-width"] = x))), p.zIndex = c2, A += "-" + c2, (k = t3.plotLinesAndBandsGroups[A]) || (t3.plotLinesAndBandsGroups[A] = k = u.g("plot-" + A).attr(p).add()), v || (this.svgElem = v = u.path().attr(T).add(k)), o(m))
        ...
        var r;
        let { format: n } = t2, { composed: a, doc: h, isSafari: l } = e2, { distribute: d } = i2, { addEvent: c, clamp: p, css: u, discardElement: g, extend: f, fireEvent: m, isArray: x, isNumber: y, isString: b, merge: v, pick: S, pushUnique: k, splat: M, syncTimeout: C } = o;
        class w {
          constructor(t3, e3) {
          ...
          getAnchor(t3, e3) {
            ...
            if ((t3 = M(t3))[0].series && t3[0].series.yAxis && !t3[0].series.yAxis.options.reversedStacks && (t3 = t3.slice().reverse()), this.followPointer && e3)
          ...
          getLabel() {
            ...
            if (!this.label) {
              if (this.outside) {
                ...
                this.container = n2 = e2.doc.createElement("div"), n2.className = "highcharts-tooltip-container", u(n2, { position: "absolute", top: "1px", pointerEvents: "none", zIndex: Math.max(this.options.style.zIndex || 0, (t4 && t4.zIndex || 0) + 3) }), this.renderer = a2 = new i4(n2, 0, 0, t4, void 0, void 0, a2.styledMode);
              }
          ...
          getPlayingField() {
            let { body: t3, documentElement: e3 } = h, { chart: i3, distance: s2, outside: o2 } = this;
          ...
          getPosition(t3, e3, i3) {
            var _a, _b;
            let { distance: s2, chart: o2, outside: r2 } = this, { inverted: n2, plotLeft: a2, plotTop: h2, polar: l2 } = o2, { plotX: d2 = 0, plotY: c2 = 0 } = i3, p2 = {}, u2 = n2 && i3.h || 0, { height: g2, width: f2 } = this.getPlayingField(), m2 = o2.pointer.getChartPosition(), x2 = (t4) => t4 * m2.scaleX, y2 = (t4) => t4 * m2.scaleY, b2 = (i4) => {
              let n3 = "x" === i4;
              return [i4, n3 ? f2 : g2, n3 ? t3 : e3].concat(r2 ? [n3 ? x2(t3) : y2(e3), n3 ? m2.left - s2 + x2(d2 + a2) : m2.top - s2 + y2(c2 + h2), 0, n3 ? f2 : g2] : [n3 ? t3 : e3, n3 ? d2 + a2 : c2 + h2, n3 ? a2 : h2, n3 ? a2 + o2.plotWidth : h2 + o2.plotHeight]);
            }, v2 = b2("y"), k2 = b2("x"), M2, C2 = !!i3.negative;
            !l2 && ((_b = (_a = o2.hoverSeries) == null ? void 0 : _a.yAxis) == null ? void 0 : _b.reversed) && (C2 = !C2);
            let w2 = !this.followPointer && S(i3.ttBelow, !l2 && !n2 === C2), T = function(t4, e4, i4, o3, n3, a3, h3) {
              let l3 = r2 ? "y" === t4 ? y2(s2) : x2(s2) : s2, d3 = (i4 - o3) / 2, c3 = o3 < n3 - s2, g3 = n3 + s2 + o3 < e4, f3 = n3 - l3 - i4 + d3, m3 = n3 + l3 - d3;
              if (w2 && g3)
                p2[t4] = m3;
              else if (!w2 && c3)
                p2[t4] = f3;
              else if (c3)
                p2[t4] = Math.min(h3 - o3, f3 - u2 < 0 ? f3 : f3 - u2);
              else {
                if (!g3)
                  return false;
                p2[t4] = Math.max(a3, m3 + u2 + i4 > e4 ? m3 : m3 + u2);
              }
            }, A = function(t4, e4, i4, o3, r3) {
              if (r3 < s2 || r3 > e4 - s2)
                return false;
              r3 < i4 / 2 ? p2[t4] = 1 : r3 > e4 - o3 / 2 ? p2[t4] = e4 - o3 - 2 : p2[t4] = r3 - i4 / 2;
            }, P = function(t4) {
              [v2, k2] = [k2, v2], M2 = t4;
            }, L = () => {
              false !== T.apply(0, v2) ? false !== A.apply(0, k2) || M2 || (P(true), L()) : M2 ? p2.x = p2.y = 0 : (P(true), L());
            };
            return (n2 && !l2 || this.len > 1) && P(), L(), p2;
          }
          hide(t3) {
            let e3 = this;
          ...
          move(t3, e3, i3, s2) {
            ...
            f(n2, { x: a2 ? (2 * n2.x + t3) / 3 : t3, y: a2 ? (n2.y + e3) / 2 : e3, anchorX: h2 ? void 0 : a2 ? (2 * n2.anchorX + i3) / 3 : i3, anchorY: h2 ? void 0 : a2 ? (n2.anchorY + s2) / 2 : s2 }), r2.getLabel().attr(n2), r2.drawTracker(), a2 && (o.clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() {
              r2 && r2.move(t3, e3, i3, s2);
            }, 32));
          }
          refresh(t3, e3) {
            let i3 = this.chart, s2 = this.options, r2 = i3.pointer, a2 = M(t3), h2 = a2[0], l2 = [], d2 = s2.format, c2 = s2.formatter || this.defaultFormatter, p2 = this.shared, u2 = i3.styledMode, g2 = {};
            ...
            p2 && this.allowShared ? (r2.applyInactiveState(a2), a2.forEach(function(t4) {
              t4.setState("hover"), l2.push(t4.getLabelConfig());
            }), (g2 = h2.getLabelConfig()).points = l2) : g2 = h2.getLabelConfig(), this.len = l2.length;
            let k2 = b(d2) ? n(d2, g2, i3) : c2.call(g2, this), C2 = h2.series;
            if (this.distance = S(C2.tooltipOptions.distance, 16), false === k2)
              this.hide();
            else {
              if (this.split && this.allowShared)
                this.renderSplit(k2, a2);
              else {
                let t4 = y2, o2 = v2;
                if (e3 && r2.isDirectTouch && (t4 = e3.chartX - i3.plotLeft, o2 = e3.chartY - i3.plotTop), i3.polar || false === C2.options.clip || a2.some((e4) => r2.isDirectTouch || e4.series.shouldShowTooltip(t4, o2))) {
                  ...
                  (!s2.style.width || u2) && t5.css({ width: (this.outside ? this.getPlayingField() : i3.spacingBox).width + "px" }), t5.attr({ text: k2 && k2.join ? k2.join("") : k2 }), t5.addClass(this.getClassName(h2), true), u2 || t5.attr({ stroke: s2.borderColor || h2.color || C2.color || "#666666" }), this.updatePosition({ plotX: y2, plotY: v2, negative: h2.negative, ttBelow: h2.ttBelow, h: f2[2] || 0 });
                } else {
                  this.hide();
                  return;
                }
          ...
          renderSplit(t3, e3) {
            let i3 = this, { chart: s2, chart: { chartWidth: o2, chartHeight: r2, plotHeight: n2, plotLeft: a2, plotTop: c2, pointer: u2, scrollablePixelsY: g2 = 0, scrollablePixelsX: m2, scrollingContainer: { scrollLeft: x2, scrollTop: y2 } = { scrollLeft: 0, scrollTop: 0 }, styledMode: v2 }, distance: k2, options: M2, options: { positioner: C2 } } = i3, w2 = i3.outside && "number" != typeof m2 ? h.documentElement.getBoundingClientRect() : { left: x2, right: x2 + o2, top: y2, bottom: y2 + r2 }, T = i3.getLabel(), A = this.renderer || s2.renderer, P = !!(s2.xAxis[0] && s2.xAxis[0].opposite), { left: L, top: O } = u2.getChartPosition(), D = c2 + y2, E = 0, j = n2 - g2;
            function I(t4, e4, s3, o3, r3 = true) {
              let n3, a3;
              return s3 ? (n3 = P ? 0 : j, a3 = p(t4 - o3 / 2, w2.left, w2.right - o3 - (i3.outside ? L : 0))) : (n3 = e4 - D, a3 = p(a3 = r3 ? t4 - o3 - k2 : t4 + k2, r3 ? a3 : w2.left, w2.right)), { x: a3, y: n3 };
            }
            b(t3) && (t3 = [false, t3]);
            let B = t3.slice(0, e3.length + 1).reduce(function(t4, s3, o3) {
              if (false !== s3 && "" !== s3) {
                let r3 = e3[o3 - 1] || { isHeader: true, plotX: e3[0].plotX, plotY: n2, series: {} }, h2 = r3.isHeader, l2 = h2 ? i3 : r3.series, d2 = l2.tt = function(t5, e4, s4) {
                  let o4 = t5, { isHeader: r4, series: n3 } = e4;
                  if (!o4) {
                    let t6 = { padding: M2.padding, r: M2.borderRadius };
                    v2 || (t6.fill = M2.backgroundColor, t6["stroke-width"] = M2.borderWidth ?? 1), o4 = A.label("", 0, 0, M2[r4 ? "headerShape" : "shape"], void 0, void 0, M2.useHTML).addClass(i3.getClassName(e4, true, r4)).attr(t6).add(T);
                  }
                  return o4.isActive = true, o4.attr({ text: s4 }), v2 || o4.css(M2.style).attr({ stroke: M2.borderColor || e4.color || n3.color || "#333333" }), o4;
                }(l2.tt, r3, s3.toString()), u3 = d2.getBBox(), g3 = u3.width + d2.strokeWidth();
                h2 && (E = u3.height, j += E, P && (D -= E));
                let { anchorX: f2, anchorY: m3 } = function(t5) {
                  let e4, i4;
                  let { isHeader: s4, plotX: o4 = 0, plotY: r4 = 0, series: h3 } = t5;
                  if (s4)
                    e4 = Math.max(a2 + o4, a2), i4 = c2 + n2 / 2;
                  else {
                    let { xAxis: t6, yAxis: s5 } = h3;
                    e4 = t6.pos + p(o4, -k2, t6.len + k2), h3.shouldShowTooltip(0, s5.pos - c2 + r4, { ignoreX: true }) && (i4 = s5.pos + r4);
                  }
                  return { anchorX: e4 = p(e4, w2.left - k2, w2.right + k2), anchorY: i4 };
                }(r3);
                if ("number" == typeof m3) {
                  let e4 = u3.height + 1, s4 = C2 ? C2.call(i3, g3, e4, r3) : I(f2, m3, h2, g3);
                  t4.push({ align: C2 ? 0 : void 0, anchorX: f2, anchorY: m3, boxWidth: g3, point: r3, rank: S(s4.rank, h2 ? 1 : 0), size: e4, target: s4.y, tt: d2, x: s4.x });
                } else
                  d2.isActive = false;
              }
              return t4;
            ...
            !C2 && B.some((t4) => {
              ...
              let { x: e4, y: i4 } = I(t4.anchorX, t4.anchorY, t4.point.isHeader, t4.boxWidth, false);
            ...
            B.forEach(function(t4) {
              ...
              let { x: e4, anchorX: s3, anchorY: o3, pos: r3, point: { isHeader: n3 } } = t4, a3 = { visibility: void 0 === r3 ? "hidden" : "inherit", x: e4, y: (r3 || 0) + D, anchorX: s3, anchorY: o3 };
              if (i3.outside && e4 < s3) {
                let t5 = L - R.left;
          ...
          tooltipFooterHeaderFormatter(t3, e3) {
            let i3 = t3.series, s2 = i3.tooltipOptions, o2 = i3.xAxis, r2 = o2 && o2.dateTime, a2 = { isFooter: e3, labelConfig: t3 }, h2 = s2.xDateFormat, l2 = s2[e3 ? "footerFormat" : "headerFormat"];
            return m(this, "headerFormatter", a2, function(e4) {
              r2 && !h2 && y(t3.key) && (h2 = r2.getXDateFormat(t3.key, s2.dateTimeLabelFormats)), r2 && h2 && (t3.point && t3.point.tooltipDateKeys || ["key"]).forEach(function(t4) {
                l2 = l2.replace("{point." + t4 + "}", "{point." + t4 + ":" + h2 + "}");
              }), i3.chart.styledMode && (l2 = this.styledModeFormat(l2)), e4.text = n(l2, { point: t3, series: i3 }, this.chart);
            }), a2.text;
          }
          update(t3) {
          ...
          updatePosition(t3) {
            let { chart: e3, container: i3, distance: s2, options: o2, renderer: r2 } = this, { height: n2 = 0, width: a2 = 0 } = this.getLabel(), h2 = e3.pointer, { left: l2, top: d2, scaleX: c2, scaleY: p2 } = h2.getChartPosition(), g2 = (o2.positioner || this.getPosition).call(this, a2, n2, t3), f2 = (t3.plotX || 0) + e3.plotLeft, m2 = (t3.plotY || 0) + e3.plotTop, x2;
            r2 && i3 && (o2.positioner && (g2.x += l2 - s2, g2.y += d2 - s2), x2 = (o2.borderWidth || 0) + 2 * s2 + 2, r2.setSize(a2 + x2, n2 + x2, false), (1 !== c2 || 1 !== p2) && (u(i3, { transform: `scale(${c2}, ${p2})` }), f2 *= c2, m2 *= p2), f2 += l2 - g2.x, m2 += d2 - g2.y), this.move(Math.round(g2.x), Math.round(g2.y || 0), f2, m2);
          }
        }
        return (r = w || (w = {})).compose = function t3(e3) {
          k(a, t3) && c(e3, "afterInit", function() {
            let t4 = this.chart;
            t4.options.tooltip && (t4.tooltip = new r(t4, t4.options.tooltip));
          });
        }, w;
        ...
        let { animObject: r } = e2, { defaultOptions: n } = i2, { format: a } = s, { addEvent: h, defined: l, erase: d, extend: c, fireEvent: p, getNestedProperty: u, isArray: g, isFunction: f, isNumber: m, isObject: x, merge: y, objectEach: b, pick: v, syncTimeout: S, removeEvent: k, uniqueKey: M } = o;
        class C {
          ...
          destroy() {
            if (!this.destroyed) {
              let t3 = this, e3 = t3.series, i3 = e3.chart, s2 = e3.options.dataSorting, o2 = i3.hoverPoints, n2 = t3.series.chart.renderer.globalAnimation, a2 = r(n2), h2 = () => {
                for (let e4 in (t3.graphic || t3.graphics || t3.dataLabel || t3.dataLabels) && (k(t3), t3.destroyElements()), t3)
                  delete t3[e4];
              };
              t3.legendItem && i3.legend.destroyItem(t3), o2 && (t3.setState(), d(o2, t3), o2.length || (i3.hoverPoints = null)), t3 === i3.hoverPoint && t3.onMouseOut(), s2 && s2.enabled ? (this.animateBeforeDestroy(), S(h2, a2.duration)) : h2(), i3.pointCount--;
            }
            this.destroyed = true;
          }
          destroyElements(t3) {
          ...
          constructor(t3, e3, i3) {
            this.formatPrefix = "point", this.visible = true, this.series = t3, this.applyOptions(e3, i3), this.id ?? (this.id = M()), this.resolveColor(), t3.chart.pointCount++, p(this, "afterInit");
          }
          isValid() {
          ...
          update(t3, e3, i3, s2) {
            ...
            function d2() {
              ...
              a2 && d3 && (r2.graphic = a2.destroy(), delete r2.hasMockGraphic), x(t3, true) && (a2 && a2.element && t3 && t3.marker && void 0 !== t3.marker.symbol && (r2.graphic = a2.destroy()), (t3 == null ? void 0 : t3.dataLabels) && r2.dataLabel && (r2.dataLabel = r2.dataLabel.destroy())), o2 = r2.index, n2.updateParallelArrays(r2, o2), l2.data[o2] = x(l2.data[o2], true) || x(t3, true) ? r2.options : v(t3, l2.data[o2]), n2.isDirty = n2.isDirtyData = true, !n2.fixedBox && n2.hasCartesianSeries && (h2.isDirtyBox = true), "point" === l2.legendType && (h2.isDirtyLegend = true), e3 && h2.redraw(i3);
            }
          ...
          setState(e3, i3) {
            let s2 = this.series, o2 = this.state, r2 = s2.options.states[e3 || "normal"] || {}, a2 = n.plotOptions[s2.type].marker && s2.options.marker, h2 = a2 && false === a2.enabled, l2 = a2 && a2.states && a2.states[e3 || "normal"] || {}, d2 = false === l2.enabled, u2 = this.marker || {}, g2 = s2.chart, f2 = a2 && s2.markerAttribs, x2 = s2.halo, y2, b2, S2, k2 = s2.stateMarkerGraphic, M2;
            ...
            if (this.state = e3, f2 && (y2 = s2.markerAttribs(this, e3)), this.graphic && !this.hasMockGraphic) {
              if (o2 && this.graphic.removeClass("highcharts-point-" + o2), e3 && this.graphic.addClass("highcharts-point-" + e3), !g2.styledMode) {
                b2 = s2.pointAttribs(this, e3), S2 = v(g2.options.chart.animation, r2.animation);
                let t3 = b2.opacity;
                ...
                }), this.graphic.animate(b2, S2);
              }
              y2 && this.graphic.animate(y2, v(g2.options.chart.animation, l2.animation, a2.animation)), k2 && k2.hide();
            } else
              e3 && l2 && (M2 = u2.symbol || s2.symbol, k2 && k2.currentSymbol !== M2 && (k2 = k2.destroy()), y2 && (k2 ? k2[i3 ? "animate" : "attr"]({ x: y2.x, y: y2.y }) : M2 && (s2.stateMarkerGraphic = k2 = g2.renderer.symbol(M2, y2.x, y2.y, y2.width, y2.height).add(s2.markerGroup), k2.currentSymbol = M2)), !g2.styledMode && k2 && "inactive" !== this.state && k2.attr(s2.pointAttribs(this, e3))), k2 && (k2[e3 && this.isInside ? "show" : "hide"](), k2.element.point = this, k2.addClass(this.getClassName(), true));
            let C2 = r2.halo, w = this.graphic || k2, T = w && w.visibility || "inherit";
        ...
        var s;
        let { parse: o } = t2, { charts: r, composed: n, noop: a } = e2, { addEvent: h, attr: l, css: d, defined: c, extend: p, find: u, fireEvent: g, isNumber: f, isObject: m, objectEach: x, offset: y, pick: b, pushUnique: v, splat: S } = i2;
        class k {
          ...
          destroy() {
            let t3 = this;
            this.eventsToUnbind.forEach((t4) => t4()), this.eventsToUnbind = [], !e2.chartCount && (k.unbindDocumentMouseUp && (k.unbindDocumentMouseUp = k.unbindDocumentMouseUp()), k.unbindDocumentTouchEnd && (k.unbindDocumentTouchEnd = k.unbindDocumentTouchEnd())), clearInterval(t3.tooltipTimeout), x(t3, function(e3, i3) {
              t3[i3] = void 0;
            });
          }
          getSelectionMarkerAttrs(t3, e3) {
            let i3 = { args: { chartX: t3, chartY: e3 }, attrs: {}, shapeType: "rect" };
            return g(this, "getSelectionMarkerAttrs", i3, (i4) => {
              let s2;
          ...
          drag(t3) {
            let e3 = this.chart, i3 = e3.options.chart, s2 = e3.plotLeft, r2 = e3.plotTop, n2 = e3.plotWidth, a2 = e3.plotHeight, h2 = this.mouseDownX || 0, l2 = this.mouseDownY || 0, d2 = m(i3.panning) ? i3.panning && i3.panning.enabled : i3.panning, c2 = i3.panKey && t3[i3.panKey + "Key"], p2 = t3.chartX, u2 = t3.chartY, g2, f2 = this.selectionMarker;
            if ((!f2 || !f2.touch) && (p2 < s2 ? p2 = s2 : p2 > s2 + n2 && (p2 = s2 + n2), u2 < r2 ? u2 = r2 : u2 > r2 + a2 && (u2 = r2 + a2), this.hasDragged = Math.sqrt(Math.pow(h2 - p2, 2) + Math.pow(l2 - u2, 2)), this.hasDragged > 10)) {
              g2 = e3.isInsidePlot(h2 - s2, l2 - r2, { visiblePlotOnly: true });
              let { shapeType: n3, attrs: a3 } = this.getSelectionMarkerAttrs(p2, u2);
              (e3.hasCartesianSeries || e3.mapView) && (this.zoomX || this.zoomY) && g2 && !c2 && !f2 && (this.selectionMarker = f2 = e3.renderer[n3](), f2.attr({ class: "highcharts-selection-marker", zIndex: 7 }).add(), e3.styledMode || f2.attr({ fill: i3.selectionMarkerFill || o("#334eff").setOpacity(0.25).get() })), f2 && f2.attr(a3), g2 && !f2 && d2 && e3.pan(t3, i3.panning);
            }
          }
          dragStart(t3) {
            let e3 = this.chart;
          ...
          getSelectionBox(t3) {
            ...
            return g(this, "getSelectionBox", e3, (e4) => {
          ...
          drop(t3) {
            ...
            if (this.selectionMarker) {
              let { x: o2, y: r2, width: n2, height: a2 } = this.getSelectionBox(this.selectionMarker), h2 = { originalEvent: t3, xAxis: [], yAxis: [], x: o2, y: r2, width: n2, height: a2 }, l2 = !!i3.mapView;
              (this.hasDragged || s2) && (i3.axes.forEach(function(i4) {
                if (i4.zoomEnabled && c(i4.min) && (s2 || e3[{ xAxis: "zoomX", yAxis: "zoomY" }[i4.coll]]) && f(o2) && f(r2) && f(n2) && f(a2)) {
                  let e4 = i4.horiz, s3 = "touchend" === t3.type ? i4.minPixelPadding : 0, d2 = i4.toValue((e4 ? o2 : r2) + s3), c2 = i4.toValue((e4 ? o2 + n2 : r2 + a2) - s3);
                  h2[i4.coll].push({ axis: i4, min: Math.min(d2, c2), max: Math.max(d2, c2) }), l2 = true;
                }
              }), l2 && g(i3, "selection", h2, function(t4) {
                i3.zoom(p(t4, s2 ? { animation: false } : null));
              })), f(i3.index) && (this.selectionMarker = this.selectionMarker.destroy()), s2 && this.scaleGroups();
            }
            i3 && f(i3.index) && (d(i3.container, { cursor: i3._cursor }), i3.cancelClick = +this.hasDragged > 10, i3.mouseIsDown = this.hasDragged = this.hasPinched = false, this.pinchDown = []);
          }
          findNearestKDPoint(t3, e3, i3) {
            ...
            return t3.forEach(function(t4) {
              ...
              m(n2, true) && n2.series && (!m(s2, true) || function(t5, i4) {
          ...
          getChartCoordinatesFromPoint(t3, e3) {
            ...
            if (s2 && o2) {
              let i4 = b(t3.clientX, t3.plotX), n2 = t3.plotY || 0;
              return t3.isNode && r2 && f(r2.x) && f(r2.y) && (i4 = r2.x, n2 = r2.y), e3 ? { chartX: o2.len + o2.pos - n2, chartY: s2.len + s2.pos - i4 } : { chartX: i4 + s2.pos, chartY: n2 + o2.pos };
            }
            if (r2 && r2.x && r2.y)
          ...
          getChartPosition() {
            ...
            let { container: t3 } = this.chart, e3 = y(t3);
          ...
          getHoverData(t3, e3, i3, s2, o2, r2) {
            let n2 = [], a2 = function(t4) {
              return t4.visible && !(!o2 && t4.directTouch) && b(t4.options.enableMouseTracking, true);
            }, h2 = e3, l2, d2 = { chartX: r2 ? r2.chartX : void 0, chartY: r2 ? r2.chartY : void 0, shared: o2 };
            g(this, "beforeGetHoverData", d2);
            let c2 = h2 && !h2.stickyTracking;
            l2 = c2 ? [h2] : i3.filter((t4) => t4.stickyTracking && (d2.filter || a2)(t4));
            let p2 = s2 && t3 || !r2 ? t3 : this.findNearestKDPoint(l2, o2, r2);
            return h2 = p2 && p2.series, p2 && (o2 && !h2.noSharedTooltip ? (l2 = i3.filter(function(t4) {
              return d2.filter ? d2.filter(t4) : a2(t4) && !t4.noSharedTooltip;
            })).forEach(function(t4) {
              let e4 = u(t4.points, function(t5) {
                return t5.x === p2.x && !t5.isNull;
              });
              m(e4) && (t4.boosted && t4.boost && (e4 = t4.boost.getPoint(e4)), n2.push(e4));
            }) : n2.push(p2)), g(this, "afterGetHoverData", d2 = { hoverPoint: p2 }), { hoverPoint: d2.hoverPoint, hoverSeries: h2, hoverPoints: n2 };
          }
          ...
          constructor(t3, e3) {
            var _a;
            this.hasDragged = false, this.lastValidTouch = {}, this.pinchDown = [], this.eventsToUnbind = [], this.options = e3, this.chart = t3, this.runChartClick = !!((_a = e3.chart.events) == null ? void 0 : _a.click), this.pinchDown = [], this.lastValidTouch = {}, this.setDOMEvents(), g(this, "afterInit");
          }
          normalize(t3, e3) {
            let i3 = t3.touches, s2 = i3 ? i3.length ? i3.item(0) : b(i3.changedTouches, t3.changedTouches)[0] : t3;
            e3 || (e3 = this.getChartPosition());
            let o2 = s2.pageX - e3.left, r2 = s2.pageY - e3.top;
            return p(t3, { chartX: Math.round(o2 /= e3.scaleX), chartY: Math.round(r2 /= e3.scaleY) });
          }
          onContainerClick(t3) {
            let e3 = this.chart, i3 = e3.hoverPoint, s2 = this.normalize(t3), o2 = e3.plotLeft, r2 = e3.plotTop;
            !e3.cancelClick && (i3 && this.inClass(s2.target, "highcharts-tracker") ? (g(i3.series, "click", p(s2, { point: i3 })), e3.hoverPoint && i3.firePointEvent("click", s2)) : (p(s2, this.getCoordinates(s2)), e3.isInsidePlot(s2.chartX - o2, s2.chartY - r2, { visiblePlotOnly: true }) && g(e3, "click", s2)));
          }
          ...
          onContainerMouseLeave(t3) {
            let e3 = r[b(k.hoverChartIndex, -1)];
          ...
          pinch(t3) {
            let e3 = this, i3 = e3.chart, s2 = e3.pinchDown, o2 = t3.touches || [], r2 = o2.length, n2 = e3.lastValidTouch, h2 = e3.hasZoom, l2 = {}, d2 = 1 === r2 && (e3.inClass(t3.target, "highcharts-tracker") && i3.runTrackerClick || e3.runChartClick), c2 = {}, u2 = e3.chart.tooltip, f2 = 1 === r2 && b(u2 && u2.options.followTouchMove, true), m2 = e3.selectionMarker;
            r2 > 1 ? e3.initiated = true : f2 && (e3.initiated = false), h2 && e3.initiated && !d2 && false !== t3.cancelable && t3.preventDefault(), [].map.call(o2, function(t4) {
              return e3.normalize(t4);
            }), "touchstart" === t3.type ? ([].forEach.call(o2, function(t4, e4) {
              s2[e4] = { chartX: t4.chartX, chartY: t4.chartY };
            }), n2.x = [s2[0].chartX, s2[1] && s2[1].chartX], n2.y = [s2[0].chartY, s2[1] && s2[1].chartY], i3.axes.forEach(function(t4) {
              if (t4.zoomEnabled) {
                let e4 = i3.bounds[t4.horiz ? "h" : "v"], s3 = t4.minPixelPadding, o3 = t4.toPixels(Math.min(b(t4.options.min, t4.dataMin), t4.dataMin)), r3 = t4.toPixels(Math.max(b(t4.options.max, t4.dataMax), t4.dataMax)), n3 = Math.min(o3, r3), a2 = Math.max(o3, r3);
                e4.min = Math.min(t4.pos, n3 - s3), e4.max = Math.max(t4.pos + t4.len, a2 + s3);
              }
            }), e3.res = true) : f2 ? this.runPointActions(e3.normalize(t3)) : s2.length && (g(i3, "touchpan", { originalEvent: t3 }, () => {
              m2 || (e3.selectionMarker = m2 = p({ destroy: a, touch: true }, i3.plotBox)), e3.pinchTranslate(s2, o2, l2, m2, c2, n2), e3.hasPinched = h2, e3.scaleGroups(l2, c2);
          ...
          pinchTranslateDirection(t3, e3, i3, s2, o2, r2, n2, a2) {
            let h2 = this.chart, l2 = t3 ? "x" : "y", d2 = t3 ? "X" : "Y", c2 = "chart" + d2, p2 = t3 ? "width" : "height", u2 = h2["plot" + (t3 ? "Left" : "Top")], g2 = h2.inverted, f2 = h2.bounds[t3 ? "h" : "v"], m2 = 1 === e3.length, x2 = e3[0][c2], y2 = !m2 && e3[1][c2], b2 = function() {
              "number" == typeof w && Math.abs(x2 - y2) > 20 && (M = a2 || Math.abs(C - w) / Math.abs(x2 - y2)), k2 = (u2 - C) / M + x2, v2 = h2["plot" + (t3 ? "Width" : "Height")] / M;
            }, v2, S2, k2, M = a2 || 1, C = i3[0][c2], w = !m2 && i3[1][c2], T;
            b2(), (S2 = k2) < f2.min ? (S2 = f2.min, T = true) : S2 + v2 > f2.max && (S2 = f2.max - v2, T = true), T ? (C -= 0.8 * (C - n2[l2][0]), "number" == typeof w && (w -= 0.8 * (w - n2[l2][1])), b2()) : n2[l2] = [C, w], g2 || (r2[l2] = k2 - u2, r2[p2] = v2);
            let A = g2 ? t3 ? "scaleY" : "scaleX" : "scale" + d2, P = g2 ? 1 / M : M;
            o2[p2] = v2, o2[l2] = S2, s2[A] = M * (g2 && !t3 ? -1 : 1), s2["translate" + d2] = P * u2 + (C - P * x2);
          }
          reset(t3, e3) {
            let i3 = this.chart, s2 = i3.hoverSeries, o2 = i3.hoverPoint, r2 = i3.hoverPoints, n2 = i3.tooltip, a2 = n2 && n2.shared ? r2 : o2;
            t3 && a2 && S(a2).forEach(function(e4) {
              e4.series.isCartesian && void 0 === e4.plotX && (t3 = false);
            }), t3 ? n2 && a2 && S(a2).length && (n2.refresh(a2), n2.shared && r2 ? r2.forEach(function(t4) {
          ...
          runPointActions(t3, e3, i3) {
            let s2 = this.chart, o2 = s2.series, n2 = s2.tooltip && s2.tooltip.options.enabled ? s2.tooltip : void 0, a2 = !!n2 && n2.shared, l2 = e3 || s2.hoverPoint, d2 = l2 && l2.series || s2.hoverSeries, c2 = (!t3 || "touchmove" !== t3.type) && (!!e3 || d2 && d2.directTouch && this.isDirectTouch), p2 = this.getHoverData(l2, d2, o2, c2, a2, t3);
            l2 = p2.hoverPoint, d2 = p2.hoverSeries;
            let g2 = p2.hoverPoints, f2 = d2 && d2.tooltipOptions.followPointer && !d2.tooltipOptions.split, m2 = a2 && d2 && !d2.noSharedTooltip;
            ...
            this.unDocMouseMove || (this.unDocMouseMove = h(s2.container.ownerDocument, "mousemove", function(t4) {
              let e4 = r[k.hoverChartIndex];
              e4 && e4.pointer.onDocumentMouseMove(t4);
            }), this.eventsToUnbind.push(this.unDocMouseMove)), s2.axes.forEach(function(e4) {
              let i4;
              let o3 = b((e4.crosshair || {}).snap, true);
              !o3 || (i4 = s2.hoverPoint) && i4.series[e4.coll] === e4 || (i4 = u(g2, (t4) => t4.series && t4.series[e4.coll] === e4)), i4 || !o3 ? e4.drawCrosshair(t3, i4) : e4.hideCrosshair();
            });
          }
          scaleGroups(t3, e3) {
            let i3 = this.chart;
          ...
          setDOMEvents() {
            ...
            t3.onmousedown = this.onContainerMouseDown.bind(this), t3.onmousemove = this.onContainerMouseMove.bind(this), t3.onclick = this.onContainerClick.bind(this), this.eventsToUnbind.push(h(t3, "mouseenter", this.onContainerMouseEnter.bind(this))), this.eventsToUnbind.push(h(t3, "mouseleave", this.onContainerMouseLeave.bind(this))), k.unbindDocumentMouseUp || (k.unbindDocumentMouseUp = h(i3, "mouseup", this.onDocumentMouseUp.bind(this)));
            let s2 = this.chart.renderTo.parentElement;
            for (; s2 && "BODY" !== s2.tagName; )
              this.eventsToUnbind.push(h(s2, "scroll", () => {
                delete this.chartPosition;
              })), s2 = s2.parentElement;
            e2.hasTouch && (this.eventsToUnbind.push(h(t3, "touchstart", this.onContainerTouchStart.bind(this), { passive: false })), this.eventsToUnbind.push(h(t3, "touchmove", this.onContainerTouchMove.bind(this), { passive: false })), k.unbindDocumentTouchEnd || (k.unbindDocumentTouchEnd = h(i3, "touchend", this.onDocumentTouchEnd.bind(this), { passive: false })));
          }
          setHoverChartIndex(t3) {
            let i3 = this.chart, s2 = e2.charts[b(k.hoverChartIndex, -1)];
            s2 && s2 !== i3 && s2.pointer.onContainerMouseLeave(t3 || { relatedTarget: i3.container }), s2 && s2.mouseIsDown || (k.hoverChartIndex = i3.index);
          }
          touch(t3, e3) {
            let i3, s2;
            let o2 = this.chart;
            this.setHoverChartIndex(), 1 === t3.touches.length ? (t3 = this.normalize(t3), o2.isInsidePlot(t3.chartX - o2.plotLeft, t3.chartY - o2.plotTop, { visiblePlotOnly: true }) && !o2.openMenu ? (e3 && this.runPointActions(t3), "touchmove" === t3.type && (i3 = !!(s2 = this.pinchDown)[0] && Math.sqrt(Math.pow(s2[0].chartX - t3.chartX, 2) + Math.pow(s2[0].chartY - t3.chartY, 2)) >= 4), b(i3, true) && this.pinch(t3)) : e3 && this.reset()) : 2 === t3.touches.length && this.pinch(t3);
          }
          touchSelect(t3) {
          ...
          zoomOption(t3) {
            ...
            /touch/.test(t3.type) && (s2 = b(e3.zooming.pinchType, s2)), this.zoomX = o2 = /x/.test(s2), this.zoomY = r2 = /y/.test(s2), this.zoomHor = o2 && !i3 || r2 && i3, this.zoomVert = r2 && !i3 || o2 && i3, this.hasZoom = o2 || r2;
          }
        }
        return (s = k || (k = {})).compose = function t3(e3) {
          v(n, t3) && h(e3, "beforeRender", function() {
        ...
        var n;
        let { animObject: a, setAnimation: h } = t2, { format: l } = e2, { composed: d, marginNames: c } = i2, { distribute: p } = o, { addEvent: u, createElement: g, css: f, defined: m, discardElement: x, find: y, fireEvent: b, isNumber: v, merge: S, pick: k, pushUnique: M, relativeLength: C, stableSort: w, syncTimeout: T } = r;
        class A {
          constructor(t3, e3) {
          ...
          colorizeItem(t3, e3) {
            let { area: i3, group: s2, label: o2, line: r2, symbol: n2 } = t3.legendItem || {};
            if (s2 == null ? void 0 : s2[e3 ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
              ...
              o2 == null ? void 0 : o2.css(S(e3 ? this.itemStyle : s3)), r2 == null ? void 0 : r2.attr(p2({ stroke: d2 || t3.color })), n2 && n2.attr(p2(c2 && n2.isMarker ? t3.pointAttribs() : { fill: t3.color })), i3 == null ? void 0 : i3.attr(p2({ fill: h2 || t3.color, "fill-opacity": h2 ? 1 : l2 ?? 0.75 }));
            }
          ...
          positionCheckboxes() {
            ...
            e3 && (t3 = e3.translateY, this.allItems.forEach(function(o2) {
              let r2;
              let n2 = o2.checkbox;
              n2 && (r2 = t3 + s2 + n2.y + (this.scrollOffset || 0) + 3, f(n2, { left: e3.translateX + o2.checkboxOffset + n2.x - 20 + "px", top: r2 + "px", display: this.proximate || r2 > t3 - 6 && r2 < t3 + i3 - 6 ? "" : "none" }));
            }, this));
          }
          renderTitle() {
          ...
          layoutItem(t3) {
            let e3 = this.options, i3 = this.padding, s2 = "horizontal" === e3.layout, o2 = t3.itemHeight, r2 = this.itemMarginBottom, n2 = this.itemMarginTop, a2 = s2 ? k(e3.itemDistance, 20) : 0, h2 = this.maxLegendWidth, l2 = e3.alignColumns && this.totalItemWidth > h2 ? this.maxItemWidth : t3.itemWidth, d2 = t3.legendItem || {};
          ...
          adjustMargins(t3, e3) {
            ...
            o2 && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(r2, n2) {
              r2.test(o2) && !m(t3[n2]) && (i3[c[n2]] = Math.max(i3[c[n2]], i3.legend[(n2 + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][n2] * s2[n2 % 2 ? "x" : "y"] + k(s2.margin, 12) + e3[n2] + (i3.titleOffset[n2] || 0)));
            });
          }
          proximatePositions() {
            let t3;
            ...
            for (let o2 of (this.allItems.forEach(function(t4) {
              ...
              t4.yAxis && (t4.xAxis.options.reversed && (n2 = !n2), t4.points && (o3 = y(n2 ? t4.points : t4.points.slice(0).reverse(), function(t5) {
                return v(t5.plotY);
          ...
          handleOverflow(t3) {
            let e3 = this, i3 = this.chart, s2 = i3.renderer, o2 = this.options, r2 = o2.y, n2 = "top" === o2.verticalAlign, a2 = this.padding, h2 = o2.maxHeight, l2 = o2.navigation, d2 = k(l2.animation, true), c2 = l2.arrowSize || 12, p2 = this.pages, u2 = this.allItems, g2 = function(t4) {
            ...
            }, m2, x2, y2, b2 = i3.spacingBox.height + (n2 ? -r2 : r2) - a2, v2 = this.nav, S2 = this.clipRect;
            return "horizontal" !== o2.layout || "middle" === o2.verticalAlign || o2.floating || (b2 /= 2), h2 && (b2 = Math.min(b2, h2)), p2.length = 0, t3 && b2 > 0 && t3 > b2 && false !== l2.enabled ? (this.clipHeight = m2 = Math.max(b2 - 20 - this.titleHeight - a2, 0), this.currentPage = k(this.currentPage, 1), this.fullHeight = t3, u2.forEach((t4, e4) => {
              y2 = t4.legendItem || {};
          ...
          scroll(t3, e3) {
            let i3 = this.chart, s2 = this.pages, o2 = s2.length, r2 = this.clipHeight, n2 = this.options.navigation, l2 = this.pager, d2 = this.padding, c2 = this.currentPage + t3;
            if (c2 > o2 && (c2 = o2), c2 > 0) {
              void 0 !== e3 && h(e3, i3), this.nav.attr({ translateX: d2, translateY: r2 + this.padding + 7 + this.titleHeight, visibility: "inherit" }), [this.up, this.upTracker].forEach(function(t5) {
              ...
              }, this), i3.styledMode || (this.up.attr({ fill: 1 === c2 ? n2.inactiveColor : n2.activeColor }), this.upTracker.css({ cursor: 1 === c2 ? "default" : "pointer" }), this.down.attr({ fill: c2 === o2 ? n2.inactiveColor : n2.activeColor }), this.downTracker.css({ cursor: c2 === o2 ? "default" : "pointer" })), this.scrollOffset = -s2[c2 - 1] + this.initialItemY, this.scrollGroup.animate({ translateY: this.scrollOffset }), this.currentPage = c2, this.positionCheckboxes();
              let t4 = a(k(e3, i3.renderer.globalAnimation, true));
              T(() => {
          ...
          setItemEvents(t3, e3, i3) {
            ...
            for (let i4 of d2)
              i4 && i4.on("mouseover", function() {
                ...
                o2.chart.styledMode || e3.css(S(t3.visible ? o2.itemStyle : o2.itemHiddenStyle)), c2(""), n2.removeClass(h2), t3.setState();
              }).on("click", function(e4) {
                let i5 = "legendItemClick", s2 = function() {
                  t3.setVisible && t3.setVisible(), c2(t3.visible ? "inactive" : "");
                };
                n2.removeClass(h2), e4 = { browserEvent: e4 }, t3.firePointEvent ? t3.firePointEvent(i5, e4, s2) : b(t3, i5, e4, s2);
              });
          }
        ...
        return (n = A || (A = {})).compose = function t3(e3) {
          M(d, t3) && u(e3, "beforeMargins", function() {
        ...
        return function(t3) {
          function e3(t4, e4, r) {
            var _a;
            let n = this.legendItem = this.legendItem || {}, { chart: a, options: h } = this, { baseline: l = 0, symbolWidth: d, symbolHeight: c } = t4, p = this.symbol || "circle", u = c / 2, g = a.renderer, f = n.group, m = l - Math.round(c * (r ? 0.4 : 0.3)), x = {}, y, b = h.marker, v = 0;
          ...
          t3.areaMarker = function(t4, i3) {
            ...
            i3.symbol = this.chart.renderer.rect(n ? (t4.symbolWidth - r) / 2 : 0, t4.baseline - r + 1, a, r, o(t4.options.symbolRadius, r / 2)).addClass("highcharts-point").attr({ zIndex: 3 }).add(i3.group);
          };
        }(e2 || (e2 = {})), e2;
        ...
        let { animObject: d, setAnimation: c } = t2, { defaultOptions: p } = e2, { registerEventOptions: u } = i2, { hasTouch: g, svg: f, win: m } = s, { seriesTypes: x } = a, { arrayMax: y, arrayMin: b, clamp: v, correctFloat: S, defined: k, destroyObjectProperties: M, diffObjects: C, erase: w, error: T, extend: A, find: P, fireEvent: L, getClosestDistance: O, getNestedProperty: D, insertItem: E, isArray: j, isNumber: I, isString: B, merge: R, objectEach: z, pick: N, removeEvent: W, splat: G, syncTimeout: H } = l;
        class X {
          constructor() {
            this.zoneAxis = "y";
          }
          ...
          autoIncrement(t3) {
            ...
            return (r2 = N(r2, e3.pointStart, 0), this.pointInterval = a2 = N(this.pointInterval, e3.pointInterval, 1), s2 && I(t3) && (a2 *= t3), i3 && (n2 = new o2.Date(r2), "day" === i3 ? o2.set("Date", n2, o2.get("Date", n2) + a2) : "month" === i3 ? o2.set("Month", n2, o2.get("Month", n2) + a2) : "year" === i3 && o2.set("FullYear", n2, o2.get("FullYear", n2) + a2), a2 = n2.getTime() - r2), s2 && I(t3)) ? r2 + a2 : (this.xIncrement = r2 + a2, r2);
          }
          setDataSortingOptions() {
            let t3 = this.options;
            A(this, { requireSorting: false, sorted: false, enabledDataSorting: true, allowDG: false }), k(t3.pointRange) || (t3.pointRange = 1);
          }
          setOptions(t3) {
            var _a, _b;
            let e3;
          ...
          getCyclic(t3, e3, i3) {
            let s2, o2;
            let r2 = this.chart, n2 = `${t3}Index`, a2 = `${t3}Counter`, h2 = (i3 == null ? void 0 : i3.length) || r2.options.chart.colorCount;
            !e3 && (k(o2 = N("color" === t3 ? this.options.colorIndex : void 0, this[n2])) ? s2 = o2 : (r2.series.length || (r2[a2] = 0), s2 = r2[a2] % h2, r2[a2] += 1), i3 && (e3 = i3[s2])), void 0 !== s2 && (this[n2] = s2), this[t3] = e3;
          }
          getColor() {
          ...
          findPointIndex(t3, e3) {
            ...
            return i3 && void 0 !== (o2 = i3 && i3.index) && (s2 = true), void 0 === o2 && I(a2) && (o2 = this.xData.indexOf(a2, e3)), -1 !== o2 && void 0 !== o2 && this.cropped && (o2 = o2 >= this.cropStart ? o2 - this.cropStart : o2), !s2 && I(o2) && h2[o2] && h2[o2].touched && (o2 = void 0), o2;
          }
          updateData(t3, e3) {
            ...
            if (this.xIncrement = null, t3.forEach(function(t4, e4) {
              let l3;
              let d3 = k(t4) && this.pointClass.prototype.optionsToObject.call({ series: this }, t4) || {}, p3 = d3.x, u2 = d3.id;
              u2 || I(p3) ? (-1 === (l3 = this.findPointIndex(d3, c2)) || void 0 === l3 ? r2.push(t4) : o2[l3] && t4 !== i3.data[l3] ? (o2[l3].update(t4, false, null, false), o2[l3].touched = true, n2 && (c2 = l3 + 1)) : o2[l3] && (o2[l3].touched = true), (!a2 || e4 !== l3 || s2 && s2.enabled || this.hasDerivedData) && (h2 = true)) : r2.push(t4);
            }, this), h2)
              for (l2 = o2.length; l2--; )
          ...
          setData(t3, e3 = true, i3, s2) {
            var _a;
            let o2 = this, r2 = o2.points, n2 = r2 && r2.length || 0, a2 = o2.options, h2 = o2.chart, l2 = a2.dataSorting, d2 = o2.xAxis, c2 = a2.turboThreshold, p2 = this.xData, u2 = this.yData, g2 = o2.pointArrayMap, f2 = g2 && g2.length, m2 = a2.keys, x2, y2, b2, v2 = 0, S2 = 1, k2 = null, M2;
            ...
            if (l2 && l2.enabled && (t3 = this.sortData(t3)), h2.options.chart.allowMutatingData && false !== s2 && C2 && n2 && !o2.cropped && !o2.hasGroupedData && o2.visible && !o2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              if (o2.xIncrement = null, o2.colorCounter = 0, this.parallelArrays.forEach(function(t4) {
                ...
                if (I(k2 = o2.getFirstValidPoint(t3)))
                  for (x2 = 0; x2 < C2; x2++)
              ...
              for (u2 && B(u2[0]) && T(14, true, h2), o2.data = [], o2.options.data = o2.userOptions.data = t3, x2 = n2; x2--; )
                (_a = r2[x2]) == null ? void 0 : _a.destroy();
          ...
          getProcessedData(t3) {
            let e3 = this, i3 = e3.xAxis, s2 = e3.options, o2 = s2.cropThreshold, r2 = t3 || e3.getExtremesFromAll || s2.getExtremesFromAll, n2 = i3 == null ? void 0 : i3.logarithmic, a2 = e3.isCartesian, h2, l2, d2 = 0, c2, p2, u2, g2 = e3.xData, f2 = e3.yData, m2 = false, x2 = g2.length;
          ...
          generatePoints() {
            ...
            for (h2 && a2 && (this.options.keys = false), g2 = 0; g2 < r2; g2++)
              p2 = n2 + g2, a2 ? ((u2 = new o2(this, [i3[g2]].concat(G(s2[g2])))).dataGroup = this.groupMap[d2 + g2], u2.dataGroup.options && (u2.options = u2.dataGroup.options, A(u2, u2.dataGroup.options), delete u2.dataLabels)) : (u2 = f2[p2]) || void 0 === e3[p2] || (f2[p2] = u2 = new o2(this, e3[p2], i3[g2])), u2 && (u2.index = a2 ? d2 + g2 : p2, l2[g2] = u2);
          ...
          getExtremes(t3, e3) {
            ...
            for (i3 && (f2 = (h2 = i3.getExtremes()).min, m2 = h2.max), u2 = 0; u2 < v2; u2++)
              if (c2 = o2[u2], l2 = (I(p2 = t3[u2]) || j(p2)) && ((I(p2) ? p2 > 0 : p2.length) || !a2), d2 = e3 || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i3 || (o2[u2 + n2] || c2) >= f2 && (o2[u2 - n2] || c2) <= m2, l2 && d2) {
                if (g2 = p2.length)
                  for (; g2--; )
                    I(p2[g2]) && (r2[x2++] = p2[g2]);
                else
            ...
            let S2 = { activeYData: r2, dataMin: b(r2), dataMax: y(r2) };
            return L(this, "afterGetExtremes", { dataExtremes: S2 }), S2;
          }
          applyExtremes() {
          ...
          translate() {
            ...
            for (p2 = 0; p2 < a2; p2++) {
              let t4;
              let a3 = n2[p2], y2 = a3.x, b2, v2, M2 = a3.y, C2 = a3.low, w2 = e3 && ((_a = r2.stacking) == null ? void 0 : _a.stacks[(this.negStacks && M2 < (c2 ? 0 : d2) ? "-" : "") + this.stackKey]);
              u2 = i3.translate(y2, false, false, false, true, h2), a3.plotX = I(u2) ? S(x2(u2)) : void 0, e3 && this.visible && w2 && w2[y2] && (f2 = this.getStackIndicator(f2, y2, this.index), !a3.isNull && f2.key && (v2 = (b2 = w2[y2]).points[f2.key]), b2 && j(v2) && (C2 = v2[0], M2 = v2[1], C2 === c2 && f2.key === w2[y2].base && (C2 = N(I(d2) ? d2 : r2.min)), r2.positiveValuesOnly && k(C2) && C2 <= 0 && (C2 = void 0), a3.total = a3.stackTotal = N(b2.total), a3.percentage = k(a3.y) && b2.total ? a3.y / b2.total * 100 : void 0, a3.stackY = M2, this.irregularWidths || b2.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis))), a3.yBottom = k(C2) ? x2(r2.translate(C2, false, true, false, true)) : void 0, this.dataModify && (M2 = this.dataModify.modifyValue(M2, p2)), I(M2) && void 0 !== a3.plotX && (t4 = I(t4 = r2.translate(M2, false, true, false, true)) ? x2(t4) : void 0), a3.plotY = t4, a3.isInside = this.isPointInside(a3), a3.clientX = l2 ? S(i3.translate(y2, false, false, false, true, h2)) : u2, a3.negative = (a3.y || 0) < (d2 || 0), a3.category = N(s2 && s2[a3.x], a3.x), a3.isNull || false === a3.visible || (void 0 !== g2 && (m2 = Math.min(m2, Math.abs(u2 - g2))), g2 = u2), a3.zone = this.zones.length ? a3.getZone() : void 0, !a3.graphic && this.group && o2 && (a3.isNew = true);
            }
          ...
          getValidPoints(t3, e3, i3) {
            ...
            return (t3 || this.points || []).filter(function(t4) {
              let { plotX: o2, plotY: r2 } = t4, n2 = !i3 && (t4.isNull || !I(r2));
          ...
          markerAttribs(t3, e3) {
            ...
            let d2 = t3.pos();
            return I(l2) && d2 && (n2.x = d2[0] - l2, n2.y = d2[1] - l2, i3.crisp && (n2.x = Math.floor(n2.x))), l2 && (n2.width = n2.height = 2 * l2), n2;
          }
          pointAttribs(t3, e3) {
          ...
          destroy(t3) {
            ...
            o2.zones.forEach(M), l.clearTimeout(o2.animationTimeout), z(o2, function(t4, e4) {
          ...
          applyZones() {
            let { area: t3, chart: e3, graph: i3, zones: s2, points: o2, xAxis: r2, yAxis: n2, zoneAxis: a2 } = this, { inverted: h2, renderer: l2 } = e3, d2 = this[`${a2}Axis`], { isXAxis: c2, len: p2 = 0 } = d2 || {}, u2 = ((i3 == null ? void 0 : i3.strokeWidth()) || 0) / 2 + 1, g2 = (t4, e4 = 0, i4 = 0) => {
              h2 && (i4 = p2 - i4);
            ...
            if (s2.length && (i3 || t3) && d2 && I(d2.min)) {
              ...
              if (s2.forEach((t4, i4) => {
                t4.lineClip = [], t4.translated = v(d2.toPixels(N(t4.value, e4), true) || 0, 0, p2);
              }), i3 && !this.showLine && i3.hide(), t3 && t3.hide(), "y" === a2 && o2.length < r2.len)
                for (let t4 of o2) {
              ...
              s2.forEach((e5) => {
                ...
                let { clip: a3, simpleClip: d3 } = e5, p3 = 0, g3 = 0, x2 = r2.len, y2 = n2.len;
                c2 ? (p3 = o3, x2 = m2) : (g3 = o3, y2 = m2);
                let b2 = [["M", p3, g3], ["L", x2, g3], ["L", x2, y2], ["L", p3, y2], ["Z"]], v2 = [b2[0], ...s3, b2[1], b2[2], ...f2, b2[3], b2[4]];
                f2 = s3.reverse(), m2 = o3, h2 && (u3(v2), t3 && u3(b2)), a3 ? (a3.animate({ d: v2 }), d3 == null ? void 0 : d3.animate({ d: b2 })) : (a3 = e5.clip = l2.path(v2), t3 && (d3 = e5.simpleClip = l2.path(b2))), i3 && ((_a = e5.graph) == null ? void 0 : _a.clip(a3)), t3 && ((_b = e5.area) == null ? void 0 : _b.clip(d3));
              });
            } else
          ...
          render() {
            var _a, _b, _c, _d, _e;
            let t3 = this, { chart: e3, options: i3, hasRendered: s2 } = t3, o2 = d(i3.animation), r2 = t3.visible ? "inherit" : "hidden", n2 = i3.zIndex, a2 = e3.seriesGroup, h2 = t3.finishedAnimating ? 0 : o2.duration;
            L(this, "render"), t3.plotGroup("group", "series", r2, n2, a2), t3.markerGroup = t3.plotGroup("markerGroup", "markers", r2, n2, a2), false !== i3.clip && t3.setClip(), h2 && ((_a = t3.animate) == null ? void 0 : _a.call(t3, true)), t3.drawGraph && (t3.drawGraph(), t3.applyZones()), t3.visible && t3.drawPoints(), (_b = t3.drawDataLabels) == null ? void 0 : _b.call(t3), (_c = t3.redrawPoints) == null ? void 0 : _c.call(t3), i3.enableMouseTracking && ((_d = t3.drawTracker) == null ? void 0 : _d.call(t3)), h2 && ((_e = t3.animate) == null ? void 0 : _e.call(t3)), s2 || (h2 && o2.defer && (h2 += o2.defer), t3.animationTimeout = H(() => {
              t3.afterAnimate();
          ...
          buildKDTree(t3) {
            ...
            delete e3.kdTree, H(function() {
              e3.kdTree = function t4(i4, s2, o2) {
                ...
                if (a2)
                  return r2 = e3.kdAxisArray[s2 % o2], i4.sort((t5, e4) => (t5[r2] || 0) - (e4[r2] || 0)), { point: i4[n2 = Math.floor(a2 / 2)], left: t4(i4.slice(0, n2), s2 + 1, o2), right: t4(i4.slice(n2 + 1), s2 + 1, o2) };
          ...
          searchKDTree(t3, e3, i3) {
            ...
            if (this.kdTree || this.buildingKdTree || this.buildKDTree(i3), this.kdTree)
              return function t4(e4, i4, a3, l2) {
                ...
                !function(t5, e5) {
                  var _a2;
                  let i5 = t5[o2], s3 = e5[o2], n3 = k(i5) && k(s3) ? i5 - s3 : null, a4 = t5[r2], l3 = e5[r2], d3 = k(a4) && k(l3) ? a4 - l3 : 0, c3 = h2 && ((_a2 = e5.marker) == null ? void 0 : _a2.radius) || 0;
          ...
          isPointInside(t3) {
            let { chart: e3, xAxis: i3, yAxis: s2 } = this, { plotX: o2 = -1, plotY: r2 = -1 } = t3, n2 = r2 >= 0 && r2 <= (s2 ? s2.len : e3.plotHeight) && o2 >= 0 && o2 <= (i3 ? i3.len : e3.plotWidth);
            return n2;
          }
          drawTracker() {
            var _a;
            let t3 = this, e3 = t3.options, i3 = e3.trackByArea, s2 = [].concat((i3 ? t3.areaPath : t3.graphPath) || []), o2 = t3.chart, r2 = o2.pointer, n2 = o2.renderer, a2 = ((_a = o2.options.tooltip) == null ? void 0 : _a.snap) || 0, h2 = () => {
              e3.enableMouseTracking && o2.hoverSeries !== t3 && t3.onMouseOver();
            }, l2 = "rgba(192,192,192," + (f ? 1e-4 : 2e-3) + ")", d2 = t3.tracker;
            d2 ? d2.attr({ d: s2 }) : t3.graph && (t3.tracker = d2 = n2.path(s2).attr({ visibility: t3.visible ? "inherit" : "hidden", zIndex: 2 }).addClass(i3 ? "highcharts-tracker-area" : "highcharts-tracker-line").add(t3.group), o2.styledMode || d2.attr({ "stroke-linecap": "round", "stroke-linejoin": "round", stroke: l2, fill: i3 ? l2 : "none", "stroke-width": t3.graph.strokeWidth() + (i3 ? 0 : 2 * a2) }), [t3.tracker, t3.markerGroup, t3.dataLabelsGroup].forEach((t4) => {
              t4 && (t4.addClass("highcharts-tracker").on("mouseover", h2).on("mouseout", (t5) => {
                r2.onTrackerMouseOut(t5);
              }), e3.cursor && !o2.styledMode && t4.css({ cursor: e3.cursor }), g && t4.on("touchstart", h2));
          ...
          update(t3, e3) {
            ...
            u2 = u2 || r2, g2 && (p2.push("data", "isDirtyData", "isDirtyCanvas", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"), false !== t3.visible && p2.push("area", "graph"), i3.parallelArrays.forEach(function(t4) {
              p2.push(t4 + "Data");
            }), t3.data && (t3.dataSorting && A(i3.options.dataSorting, t3.dataSorting), this.setData(t3.data, false))), t3 = R(o2, { index: void 0 === o2.index ? i3.index : o2.index, pointStart: ((_a = n2 == null ? void 0 : n2.series) == null ? void 0 : _a.pointStart) ?? o2.pointStart ?? ((_b = i3.xData) == null ? void 0 : _b[0]) }, !g2 && { data: i3.options.data }, t3, h2), g2 && t3.data && (t3.data = i3.options.data), (p2 = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"].concat(p2)).forEach(function(t4) {
            ...
            if (p2.forEach(function(t4) {
              ...
              for (let t4 of (false === (d2 = i3.options).visible ? (l2.graphic = 1, l2.dataLabel = 1) : (this.hasMarkerChanged(d2, o2) && (l2.graphic = 1), ((_c = i3.hasDataLabels) == null ? void 0 : _c.call(i3)) || (l2.dataLabel = 1)), this.points))
            ...
            i3.initialType = r2, s2.linkSeries(), s2.setSortedData(), f2 && i3.linkedSeries.length && (i3.isDirtyData = true), L(this, "afterUpdate"), N(e3, true) && s2.redraw(!!g2 && void 0);
          }
          setName(t3) {
          ...
          hasOptionChanged(t3) {
            var _a, _b;
            let e3 = this.chart, i3 = this.options[t3], s2 = e3.options.plotOptions, o2 = this.userOptions[t3], r2 = N((_a = s2 == null ? void 0 : s2[this.type]) == null ? void 0 : _a[t3], (_b = s2 == null ? void 0 : s2.series) == null ? void 0 : _b[t3]);
            return o2 && !k(r2) ? i3 !== o2 : i3 !== N(r2, i3);
          }
          onMouseOver() {
          ...
          setState(t3, e3) {
            let i3 = this, s2 = i3.options, o2 = i3.graph, r2 = s2.inactiveOtherPoints, n2 = s2.states, a2 = N(n2[t3 || "normal"] && n2[t3 || "normal"].animation, i3.chart.options.chart.animation), h2 = s2.lineWidth, l2 = s2.opacity;
            if (t3 = t3 || "", i3.state !== t3 && ([i3.group, i3.markerGroup, i3.dataLabelsGroup].forEach(function(e4) {
              ...
              if (n2[t3] && false === n2[t3].enabled)
                return;
              if (t3 && (h2 = n2[t3].lineWidth || h2 + (n2[t3].lineWidthPlus || 0), l2 = N(n2[t3].opacity, l2)), o2 && !o2.dashstyle && I(h2))
                for (let t4 of [o2, ...this.zones.map((t5) => t5.graph)])
                  t4 == null ? void 0 : t4.animate({ "stroke-width": h2 }, a2);
        ...
        class tt {
          ...
          isInsidePlot(t3, e3, i3 = {}) {
            ...
            return W(this, "afterIsInsidePlot", g2), g2.isInsidePlot;
          }
          redraw(t3) {
            W(this, "beforeRedraw");
            ...
            i3.forEach(function(t4) {
              t4.isDirty && ("point" === t4.options.legendType ? ("function" == typeof t4.updateTotals && t4.updateTotals(), u2 = true) : r2 && (r2.labelFormatter || r2.labelFormat) && (u2 = true)), t4.isDirtyData && W(t4, "updatedData");
              ...
              t4.extKey !== e4 && (t4.extKey = e4, h2.push(function() {
                W(t4, "afterSetExtremes", z(t4.eventArgs, t4.getExtremes())), delete t4.eventArgs;
              })), (p2 || d2) && t4.redraw();
            }), p2 && this.drawChartBox(), W(this, "predraw"), i3.forEach(function(t4) {
              (p2 || t4.isDirty) && t4.visible && t4.redraw(), t4.isDirtyData = false;
            }), s2 && s2.reset(true), n2.draw(), W(this, "redraw"), W(this, "render"), a2 && this.temporaryDisplay(true), h2.forEach(function(t4) {
              t4.call();
            });
          }
          get(t3) {
            ...
            let s2 = N(this.axes, i3) || N(this.series, i3);
            for (let t4 = 0; !s2 && t4 < e3.length; t4++)
              s2 = N(e3[t4].points || [], i3);
            return s2;
          }
          getAxes() {
            let t3 = this.userOptions;
            for (let i3 of (W(this, "getAxes"), ["xAxis", "yAxis"])) {
              let s2 = t3[i3] = K(t3[i3] || {});
              for (let t4 of s2)
                new e2(this, t4, i3);
            }
            W(this, "afterGetAxes");
          ...
          getSelectedPoints() {
            return this.series.reduce((t3, e3) => (e3.getPointsCollection().forEach((e4) => {
              $(e4.selectedStaging, e4.selected) && t3.push(e4);
            }), t3), []);
          }
          getSelectedSeries() {
          ...
          applyDescription(t3, e3) {
            ...
            }, this.styledMode || o2.css(z("title" === t3 ? { fontSize: this.options.isStock ? "1em" : "1.2em" } : {}, s2.style)), this[t3] = o2);
          }
          layOutTitles(t3 = true) {
            ...
            ["title", "subtitle", "caption"].forEach(function(t4) {
              ...
              if (o3) {
                ...
                o3.align(z({ y: "bottom" === n2 ? t5 : a2 + t5, height: h2 }, r2), false, "spacingBox"), r2.floating || ("top" === n2 ? e3[0] = Math.ceil(e3[0] + h2) : "bottom" === n2 && (e3[2] = Math.ceil(e3[2] + h2)));
              }
            ...
            this.titleOffset = e3, W(this, "afterLayOutTitles"), !this.isDirtyBox && o2 && (this.isDirtyBox = this.isDirtyLegend = o2, this.hasRendered && t3 && this.isDirtyBox && this.redraw());
          }
          getContainerBox() {
          ...
          temporaryDisplay(t3) {
            ...
            if (t3)
              for (; e3 && e3.style; )
                e3.hcOrigStyle && (D(e3, e3.hcOrigStyle), delete e3.hcOrigStyle), e3.hcOrigDetached && (k.body.removeChild(e3), e3.hcOrigDetached = false), e3 = e3.parentNode;
            else
              for (; e3 && e3.style && (k.body.contains(e3) || e3.parentNode || (e3.hcOrigDetached = true, k.body.appendChild(e3)), ("none" === G(e3, "display", false) || e3.hcOricDetached) && (e3.hcOrigStyle = { display: e3.style.display, height: e3.style.height, overflow: e3.style.overflow }, i3 = { display: "block", overflow: "hidden" }, e3 !== this.renderTo && (i3.height = 0), D(e3, i3), e3.offsetWidth || e3.style.setProperty("display", "block", "important")), (e3 = e3.parentNode) !== k.body); )
                ;
          }
          setClassName(t3) {
          ...
          getContainer() {
            let t3 = this.options, e3 = t3.chart, i3 = "data-highcharts-chart", s2 = Q(), o2, r2 = this.renderTo;
            r2 || (this.renderTo = r2 = e3.renderTo), Y(r2) && (this.renderTo = r2 = k.getElementById(r2)), r2 || R(13, true, this);
            let a2 = Z(P(r2, i3));
            X(a2) && S[a2] && S[a2].hasRendered && S[a2].destroy(), P(r2, i3, this.index), r2.innerHTML = p.emptyHTML, e3.skipClone || r2.offsetWidth || this.temporaryDisplay(), this.getChartSize();
            let h2 = this.chartWidth, d2 = this.chartHeight;
            D(r2, { overflow: "hidden" }), this.styledMode || (o2 = z({ position: "relative", overflow: "hidden", width: h2 + "px", height: d2 + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)", userSelect: "none", "touch-action": "manipulation", outline: "none" }, e3.style || {}));
            let c2 = L("div", { id: s2 }, o2, r2);
            this.container = c2, this._cursor = c2.style.cursor;
            let u2 = e3.renderer || !C ? n.getRendererType(e3.renderer) : l;
            if (this.renderer = new u2(c2, h2, d2, void 0, e3.forExport, t3.exporting && t3.exporting.allowHTML, this.styledMode), this.containerBox = this.getContainerBox(), m(void 0, this), this.setClassName(e3.className), this.styledMode)
          ...
          getMargins(t3) {
            ...
            this.resetMargins(), s2[0] && !E(i3[0]) && (this.plotTop = Math.max(this.plotTop, s2[0] + e3[0])), s2[2] && !E(i3[2]) && (this.marginBottom = Math.max(this.marginBottom, s2[2] + e3[2])), this.legend && this.legend.display && this.legend.adjustMargins(i3, e3), W(this, "getMargins"), t3 || this.getAxisMargins();
          }
          getAxisMargins() {
          ...
          reflow(t3) {
            ...
            delete e3.pointer.chartPosition, !e3.isPrinting && !e3.isResizing && i3 && s2.width && ((s2.width !== i3.width || s2.height !== i3.height) && (c.clearTimeout(e3.reflowTimeout), e3.reflowTimeout = J(function() {
          ...
          setSize(t3, e3, i3) {
            ...
            (s2.isDirtyBox || n2 !== s2.oldChartWidth || a2 !== s2.oldChartHeight) && (s2.styledMode || (r2 ? g : D)(s2.container, { width: `${n2 + h2}px`, height: `${a2 + l2}px` }, r2), s2.setChartSize(true), o2.setSize(n2, a2, r2), s2.axes.forEach(function(t4) {
              t4.isDirty = true, t4.setScale();
            }), s2.isDirtyLegend = true, s2.isDirtyBox = true, s2.layOutTitles(), s2.getMargins(), s2.redraw(r2), s2.oldChartHeight = void 0, W(s2, "resize"), setTimeout(() => {
              s2 && W(s2, "endResize", void 0, () => {
                s2.isResizing -= 1;
              });
            }, f(r2).duration));
          }
          setChartSize(t3) {
            ...
            }), n2.alignElements()), W(this, "afterSetChartSize", { skipAxes: t3 });
          }
          resetMargins() {
            W(this, "resetMargins");
            let t3 = this, e3 = t3.options.chart;
            ["margin", "spacing"].forEach(function(i3) {
              let s2 = e3[i3], o2 = F(s2) ? s2 : [s2, s2, s2, s2];
              ["Top", "Right", "Bottom", "Left"].forEach(function(s3, r2) {
                t3[i3][r2] = $(e3[i3 + s3], o2[r2]);
              });
            }), M.forEach(function(e4, i3) {
              t3[e4] = $(t3.margin[i3], t3.spacing[i3]);
          ...
          linkSeries(t3) {
            ...
            i3.forEach(function(t4) {
              ...
              if (Y(i4)) {
                let s2;
                (s2 = ":previous" === i4 ? e3.series[t4.index - 1] : e3.get(i4)) && s2.linkedParent !== t4 && (s2.linkedSeries.push(t4), t4.linkedParent = s2, s2.enabledDataSorting && t4.setDataSortingOptions(), t4.visible = $(t4.options.visible, s2.options.visible, t4.visible));
              }
            }), W(this, "afterLinkSeries", { isUpdating: t3 });
          }
          renderSeries() {
            this.series.forEach(function(t3) {
          ...
          render() {
            ...
            }, r2 = 0, n2 = true, a2, h2 = 0;
            for (let e4 of (this.setTitle(), W(this, "beforeMargins"), (_a = this.getStacks) == null ? void 0 : _a.call(this), this.getMargins(true), this.setChartSize(), t3)) {
              ...
              if (e4.horiz && e4.visible && i4.enabled && e4.series.length && "colorAxis" !== e4.coll && !this.polar) {
                ...
                if (s3.destroy(), o3 && $(i4.reserveSpace, !X(t4.crossing)) && (r2 = o3.getBBox().height + i4.distance + Math.max(t4.offset || 0, 0)), r2) {
                  o3 == null ? void 0 : o3.destroy();
                  break;
                }
              }
            }
            for (this.plotHeight = Math.max(this.plotHeight - r2, 0); (n2 || a2 || s2 > 1) && h2 < s2; ) {
          ...
          destroy() {
            ...
            for (W(e3, "destroy"), e3.renderer.forExport ? B(S, e3) : S[e3.index] = void 0, r.chartCount--, e3.renderTo.removeAttribute("data-highcharts-chart"), q(e3), t3 = i3.length; t3--; )
              i3[t3] = i3[t3].destroy();
            ...
            }), o2 && (o2.innerHTML = p.emptyHTML, q(o2), n2 && I(o2)), V(e3, function(t4, i4) {
              delete e3[i4];
            });
          }
          firstRender() {
            ...
            let i3 = H(e3.series) ? e3.series : [];
            e3.series = [], i3.forEach(function(e4) {
              t3.initSeries(e4);
            }), t3.linkSeries(), t3.setSortedData(), W(t3, "beforeRender"), t3.render(), t3.pointer.getChartPosition(), t3.renderer.imgCount || t3.hasLoaded || t3.onload(), t3.temporaryDisplay(true);
          }
          onload() {
          ...
          addSeries(t3, e3, i3) {
            let s2;
            let o2 = this;
            return t3 && (e3 = $(e3, true), W(o2, "addSeries", { options: t3 }, function() {
              s2 = o2.initSeries(t3), o2.isDirtyLegend = true, o2.linkSeries(), s2.enabledDataSorting && s2.setData(t3.data, false), W(o2, "afterAddSeries", { series: s2 }), e3 && o2.redraw(i3);
            })), s2;
          }
          addAxis(t3, e3, i3, s2) {
          ...
          createAxis(t3, i3) {
            ...
            return $(i3.redraw, true) && this.redraw(i3.animation), s2;
          }
          showLoading(t3) {
            let e3 = this, i3 = e3.options, s2 = i3.loading, o2 = function() {
              r2 && D(r2, { left: e3.plotLeft + "px", top: e3.plotTop + "px", width: e3.plotWidth + "px", height: e3.plotHeight + "px" });
            }, r2 = e3.loadingDiv, n2 = e3.loadingSpan;
            r2 || (e3.loadingDiv = r2 = L("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, e3.container)), n2 || (e3.loadingSpan = n2 = L("span", { className: "highcharts-loading-inner" }, null, r2), A(e3, "redraw", o2)), r2.className = "highcharts-loading", p.setElementHTML(n2, $(t3, i3.lang.loading, "")), e3.styledMode || (D(r2, z(s2.style, { zIndex: 10 })), D(n2, s2.labelStyle), e3.loadingShown || (D(r2, { opacity: 0, display: "" }), g(r2, { opacity: s2.style.opacity || 0.5 }, { duration: s2.showDuration || 0 }))), e3.loadingShown = true, o2();
          }
          hideLoading() {
          ...
          update(t3, e3, i3, s2) {
            ...
            W(a2, "update", { options: t3 }), l2 || a2.setResponsive(false, true), t3 = j(t3, a2.options), a2.userOptions = U(a2.userOptions, t3);
            let p2 = t3.chart;
            p2 && (U(true, a2.options.chart, p2), this.setZoomOptions(), "className" in p2 && a2.setClassName(p2.className), ("inverted" in p2 || "polar" in p2 || "type" in p2) && (a2.propFromSeries(), o2 = true), "alignTicks" in p2 && (o2 = true), "events" in p2 && v(this, p2), V(p2, function(t4, e4) {
              -1 !== a2.propsRequireUpdateSeries.indexOf("chart." + e4) && (r2 = true), -1 !== a2.propsRequireDirtyBox.indexOf(e4) && (a2.isDirtyBox = true), -1 === a2.propsRequireReflow.indexOf(e4) || (a2.isDirtyBox = true, l2 || (n2 = true));
            }), !a2.styledMode && p2.style && a2.renderer.setStyle(a2.options.chart.style || {})), !a2.styledMode && t3.colors && (this.options.colors = t3.colors), t3.time && (this.time === y && (this.time = new d(t3.time)), U(true, a2.options.time, t3.time)), V(t3, function(e4, i4) {
              a2[i4] && "function" == typeof a2[i4].update ? a2[i4].update(e4, false) : "function" == typeof a2[h2[i4]] ? a2[h2[i4]](e4) : "colors" !== i4 && -1 === a2.collectionsWithUpdate.indexOf(i4) && U(true, a2.options[i4], t3[i4]), "chart" !== i4 && -1 !== a2.propsRequireUpdateSeries.indexOf(i4) && (r2 = true);
            }), this.collectionsWithUpdate.forEach(function(e4) {
              t3[e4] && (K(t3[e4]).forEach(function(t4, s3) {
                let o3;
                let r3 = E(t4.id);
                r3 && (o3 = a2.get(t4.id)), !o3 && a2[e4] && (o3 = a2[e4][$(t4.index, s3)]) && (r3 && E(o3.options.id) || o3.options.isInternal) && (o3 = void 0), o3 && o3.coll === e4 && (o3.update(t4, false), i3 && (o3.touched = true)), !o3 && i3 && a2.collectionsWithInit[e4] && (a2.collectionsWithInit[e4][0].apply(a2, [t4].concat(a2.collectionsWithInit[e4][1] || []).concat([false])).touched = true);
            ...
            let u2 = p2 && p2.width, g2 = p2 && (Y(p2.height) ? _(p2.height, u2 || a2.chartWidth) : p2.height);
            n2 || X(u2) && u2 !== a2.chartWidth || X(g2) && g2 !== a2.chartHeight ? a2.setSize(u2, g2, s2) : $(e3, true) && a2.redraw(s2), W(a2, "afterUpdate", { options: t3, redraw: e3, animation: s2 });
          }
          setSubtitle(t3, e3) {
          ...
          showResetZoom() {
            let t3 = this, e3 = x.lang, i3 = t3.zooming.resetButton, s2 = i3.theme, o2 = "chart" === i3.relativeTo || "spacingBox" === i3.relativeTo ? null : "scrollablePlotBox";
            function r2() {
              t3.zoomOut();
            }
          ...
          zoom(t3) {
            ...
            !t3 || t3.resetSelection ? (e3.axes.forEach(function(t4) {
              ...
              (i3[n2 ? "zoomX" : "zoomY"] && E(h2) && E(l2) && e3.isInsidePlot(h2 - e3.plotLeft, l2 - e3.plotTop, { axis: r3, ignoreX: a2, ignoreY: a2 }) || !E(e3.inverted ? h2 : l2)) && (o2 = r3.zoom(t4.min, t4.max), r3.displayBtn && (s2 = true));
            });
            let r2 = e3.resetZoomButton;
            s2 && !r2 ? e3.showResetZoom() : !s2 && F(r2) && (e3.resetZoomButton = r2.destroy()), o2 && e3.redraw($(e3.options.chart.animation, t3 && t3.animation, e3.pointCount < 100));
          }
          pan(t3, e3) {
            let i3;
            ...
            let a2 = r2.type;
            W(this, "pan", { originalEvent: t3 }, function() {
              ...
              e4.forEach(function(e5) {
                ...
                m2 && !e5.isXAxis && (!b2 || b2.isDirty) && e5.series.forEach(function(t4) {
                  ...
                  b2 || (b2 = { startMin: Number.MAX_VALUE, startMax: -Number.MAX_VALUE }), X(i4.dataMin) && X(i4.dataMax) && (b2.startMin = Math.min($(t4.options.threshold, 1 / 0), i4.dataMin, b2.startMin), b2.startMax = Math.max($(t4.options.threshold, -1 / 0), i4.dataMax, b2.startMax));
                });
                let S2 = Math.min($(b2 && b2.startMin, p2.dataMin), d2 ? p2.min : e5.toValue(e5.toPixels(p2.min) - e5.minPixelPadding)), k2 = Math.max($(b2 && b2.startMax, p2.dataMax), d2 ? p2.max : e5.toValue(e5.toPixels(p2.max) + e5.minPixelPadding));
                e5.panningState = b2, e5.isOrdinal || ((v2 = S2 - x2) > 0 && (y2 += v2, x2 = S2), (v2 = y2 - k2) > 0 && (y2 = k2, x2 -= v2), e5.series.length && x2 !== p2.min && y2 !== p2.max && x2 >= S2 && y2 <= k2 && (e5.setExtremes(x2, y2, false, false, { trigger: "pan" }), !s2.resetZoomButton && x2 !== S2 && y2 !== k2 && a2.match("y") && (s2.showResetZoom(), e5.displayBtn = false), i3 = true), r3[h2] = n3);
              }), V(r3, (t4, e5) => {
                s2[e5] = t4;
              }), i3 && s2.redraw(false), D(s2.container, { cursor: "move" });
            });
          }
        }
        return z(tt.prototype, { callbacks: [], collectionsWithInit: { xAxis: [tt.prototype.addAxis, [true]], yAxis: [tt.prototype.addAxis, [false]], series: [tt.prototype.addSeries] }, collectionsWithUpdate: ["xAxis", "yAxis", "series"], propsRequireDirtyBox: ["backgroundColor", "borderColor", "borderWidth", "borderRadius", "plotBackgroundColor", "plotBackgroundImage", "plotBorderColor", "plotBorderWidth", "plotShadow", "shadow"], propsRequireReflow: ["margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "spacing", "spacingTop", "spacingRight", "spacingBottom", "spacingLeft"], propsRequireUpdateSeries: ["chart.inverted", "chart.polar", "chart.ignoreHiddenSeries", "chart.type", "colors", "plotOptions", "time", "tooltip"] }), tt;
        ...
        let { stop: o } = t2, { composed: r } = e2, { addEvent: n, createElement: a, css: h, defined: l, extend: d, merge: c, pick: p, pushUnique: u } = s;
        function g() {
          var _a, _b, _c;
          let t3;
          let { axisOffset: e3, chartWidth: s2, chartHeight: r2, container: l2, plotHeight: d2, plotLeft: c2, plotTop: u2, plotWidth: g2, scrollablePixelsX: f2 = 0, scrollablePixelsY: m2 = 0, scrollingContainer: x2 } = this, y2 = !this.fixedDiv, b2 = this.options.chart, v2 = b2.scrollablePlotArea, { scrollPositionX: S, scrollPositionY: k } = v2, M = i2.getRendererType(), { fixedRenderer: C } = this;
          C ? C.setSize(s2, r2) : (this.fixedDiv = a("div", { className: "highcharts-fixed" }, { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: (((_a = b2.style) == null ? void 0 : _a.zIndex) || 0) + 2, top: 0 }, void 0, true), x2 == null ? void 0 : x2.parentNode.insertBefore(this.fixedDiv, x2), h(this.renderTo, { overflow: "visible" }), this.fixedRenderer = C = new M(this.fixedDiv, s2, r2, b2.style), this.scrollableMask = C.path().attr({ fill: b2.backgroundColor || "#fff", "fill-opacity": p(v2.opacity, 0.85), zIndex: -1 }).addClass("highcharts-scrollable-mask").add(), n(this, "afterShowResetZoom", this.moveFixedElements), n(this, "afterApplyDrilldown", this.moveFixedElements), n(this, "afterLayOutTitles", this.moveFixedElements)), (this.scrollableDirty || y2) && (this.scrollableDirty = false, this.moveFixedElements());
          let w = s2 + f2, T = r2 + m2;
          o(this.container), h(l2, { width: `${w}px`, height: `${T}px` }), this.renderer.boxWrapper.attr({ width: w, height: T, viewBox: [0, 0, w, T].join(" ") }), (_b = this.chartBackground) == null ? void 0 : _b.attr({ width: w, height: T }), x2 && (h(x2, { width: `${this.chartWidth}px`, height: `${this.chartHeight}px` }), y2 && (S && (x2.scrollLeft = f2 * S), k && (x2.scrollTop = m2 * k)));
          let A = u2 - e3[0] - 1, P = c2 - e3[3] - 1, L = u2 + d2 + e3[2] + 1, O = c2 + g2 + e3[1] + 1, D = c2 + g2 - f2, E = u2 + d2 - m2;
          t3 = f2 ? [["M", 0, A], ["L", c2 - 1, A], ["L", c2 - 1, L], ["L", 0, L], ["Z"], ["M", D, A], ["L", s2, A], ["L", s2, L], ["L", D, L], ["Z"]] : m2 ? [["M", P, 0], ["L", P, u2 - 1], ["L", O, u2 - 1], ["L", O, 0], ["Z"], ["M", P, E], ["L", P, r2], ["L", O, r2], ["L", O, E], ["Z"]] : [["M", 0, 0]], "adjustHeight" !== this.redrawTrigger && ((_c = this.scrollableMask) == null ? void 0 : _c.attr({ d: t3 }));
        }
        function f() {
          let t3;
          let e3 = this.container, i3 = this.fixedRenderer, s2 = [".highcharts-breadcrumbs-group", ".highcharts-contextbutton", ".highcharts-caption", ".highcharts-credits", ".highcharts-legend", ".highcharts-legend-checkbox", ".highcharts-navigator-series", ".highcharts-navigator-xaxis", ".highcharts-navigator-yaxis", ".highcharts-navigator", ".highcharts-reset-zoom", ".highcharts-drillup-button", ".highcharts-scrollbar", ".highcharts-subtitle", ".highcharts-title"];
          for (let o2 of (this.scrollablePixelsX && !this.inverted ? t3 = ".highcharts-yaxis" : this.scrollablePixelsX && this.inverted ? t3 = ".highcharts-xaxis" : this.scrollablePixelsY && !this.inverted ? t3 = ".highcharts-xaxis" : this.scrollablePixelsY && this.inverted && (t3 = ".highcharts-yaxis"), t3 && s2.push(`${t3}:not(.highcharts-radial-axis)`, `${t3}-labels:not(.highcharts-radial-axis-labels)`), s2))
            [].forEach.call(e3.querySelectorAll(o2), (t4) => {
              (t4.namespaceURI === i3.SVG_NS ? i3.box : i3.box.parentNode).appendChild(t4), t4.style.pointerEvents = "auto";
            });
        }
        function m() {
          let t3;
          let e3 = { WebkitOverflowScrolling: "touch", overflowX: "hidden", overflowY: "hidden" };
          this.scrollablePixelsX && (e3.overflowX = "auto"), this.scrollablePixelsY && (e3.overflowY = "auto"), this.scrollingParent = a("div", { className: "highcharts-scrolling-parent" }, { position: "relative" }, this.renderTo), this.scrollingContainer = a("div", { className: "highcharts-scrolling" }, e3, this.scrollingParent), n(this.scrollingContainer, "scroll", () => {
        ...
        function y(t3) {
          let e3, i3, s2;
          let o2 = this.options.chart.scrollablePlotArea, r2 = o2 && o2.minWidth, n2 = o2 && o2.minHeight;
          if (!this.renderer.forExport && (r2 ? (this.scrollablePixelsX = e3 = Math.max(0, r2 - this.chartWidth), e3 && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = c(this.plotBox), this.plotBox.width = this.plotWidth += e3, this.inverted ? this.clipBox.height += e3 : this.clipBox.width += e3, s2 = { 1: { name: "right", value: e3 } })) : n2 && (this.scrollablePixelsY = i3 = Math.max(0, n2 - this.chartHeight), l(i3) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = c(this.plotBox), this.plotBox.height = this.plotHeight += i3, this.inverted ? this.clipBox.width += i3 : this.clipBox.height += i3, s2 = { 2: { name: "bottom", value: i3 } })), s2 && !t3.skipAxes))
            for (let t4 of this.axes)
              if (s2[t4.side]) {
                let e4 = t4.getPlotLinePath;
                t4.getPlotLinePath = function() {
                  let i4 = s2[t4.side].name, o3 = s2[t4.side].value, r3 = this[i4];
                  this[i4] = r3 - o3;
                  let n3 = e4.apply(this, arguments);
                  return this[i4] = r3, n3;
                };
              } else
                t4.setAxisSize(), t4.setAxisTranslation();
        }
        ...
        return { compose: function t3(e3, i3, s2) {
          u(r, t3) && (n(e3, "afterInit", x), d(i3.prototype, { applyFixed: g, moveFixedElements: f, setUpScrolling: m }), n(i3, "afterSetChartSize", y), n(i3, "render", b), n(s2, "show", v));
        } };
      ...
      }), i(e, "Core/Axis/Stacking/StackingAxis.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Axis/Axis.js"], e["Core/Globals.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Axis/Stacking/StackItem.js"], e["Core/Utilities.js"]], function(t2, e2, i2, s, o, r) {
        var n;
        let { getDeferredAnimation: a } = t2, { composed: h } = i2, { series: { prototype: l } } = s, { addEvent: d, correctFloat: c, defined: p, destroyObjectProperties: u, fireEvent: g, isArray: f, isNumber: m, objectEach: x, pick: y, pushUnique: b } = r;
        function v() {
          ...
          this.axes.forEach((t4) => {
            ...
            e3.options.stacking && e3.reserveSpace() && (e3.stackKey = [e3.type, y(e3.options.stack, ""), t3 ? i3.top : i3.left, t3 ? i3.height : i3.width].join(","));
          });
        }
        function S() {
          var _a;
        ...
        function M(t3, e3, i3, s2) {
          return !p(t3) || t3.x !== e3 || s2 && t3.stackKey !== s2 ? t3 = { x: e3, index: 0, key: s2, stackKey: s2 } : t3.index++, t3.key = [i3, e3, t3.index].join(","), t3;
        }
        function C() {
          let t3;
          ...
          a2 && [s2, "-" + s2].forEach((i4) => {
            ...
            for (; s3--; )
              n3 = r2[s3], t3 = e3.getStackIndicator(t3, n3, e3.index, i4), h2 = (_a = o2[i4]) == null ? void 0 : _a[n3], (l2 = h2 == null ? void 0 : h2.points[t3.key || ""]) && a2.call(e3, l2, h2, s3);
          });
        }
        function w(t3, e3, i3) {
          let s2 = e3.total ? 100 / e3.total : 0;
          t3[0] = c(t3[0] * s2), t3[1] = c(t3[1] * s2), this.stackedYData[i3] = t3[1];
        }
        function T(t3) {
          (this.is("column") || this.is("columnrange")) && (this.options.centerInCategory && !this.options.stacking && this.chart.series.length > 1 ? l.setStackedPoints.call(this, t3, "group") : t3.stacking.resetStacks());
        }
        function A(t3, e3) {
          var _a, _b;
          let i3, s2, r2, n2, a2, h2, l2, d2, u2;
          let g2 = e3 || this.options.stacking;
          if (!g2 || !this.reserveSpace() || ({ group: "xAxis" }[g2] || "yAxis") !== t3.coll)
            return;
          let m2 = this.processedXData, x2 = this.processedYData, b2 = [], v2 = x2.length, S2 = this.options, k2 = S2.threshold || 0, M2 = S2.startFromThreshold ? k2 : 0, C2 = S2.stack, w2 = e3 ? `${this.type},${g2}` : this.stackKey || "", T2 = "-" + w2, A2 = this.negStacks, P2 = t3.stacking, L = P2.stacks, O = P2.oldStacks;
          for (P2.stacksTouched += 1, l2 = 0; l2 < v2; l2++) {
            d2 = m2[l2], u2 = x2[l2], h2 = (i3 = this.getStackIndicator(i3, d2, this.index)).key || "", L[a2 = (s2 = A2 && u2 < (M2 ? 0 : k2)) ? T2 : w2] || (L[a2] = {}), L[a2][d2] || (((_a = O[a2]) == null ? void 0 : _a[d2]) ? (L[a2][d2] = O[a2][d2], L[a2][d2].total = null) : L[a2][d2] = new o(t3, t3.options.stackLabels, !!s2, d2, C2)), r2 = L[a2][d2], null !== u2 ? (r2.points[h2] = r2.points[this.index] = [y(r2.cumulative, M2)], p(r2.cumulative) || (r2.base = h2), r2.touched = P2.stacksTouched, i3.index > 0 && false === this.singleStacks && (r2.points[h2][0] = r2.points[this.index + "," + d2 + ",0"][0])) : (delete r2.points[h2], delete r2.points[this.index]);
            let e4 = r2.total || 0;
            "percent" === g2 ? (n2 = s2 ? w2 : T2, e4 = A2 && ((_b = L[n2]) == null ? void 0 : _b[d2]) ? (n2 = L[n2][d2]).total = Math.max(n2.total || 0, e4) + Math.abs(u2) || 0 : c(e4 + (Math.abs(u2) || 0))) : "group" === g2 ? (f(u2) && (u2 = u2[0]), null !== u2 && e4++) : e4 = c(e4 + (u2 || 0)), "group" === g2 ? r2.cumulative = (e4 || 1) - 1 : r2.cumulative = c(y(r2.cumulative, M2) + (u2 || 0)), r2.total = e4, null !== u2 && (r2.points[h2].push(r2.cumulative), b2[l2] = r2.cumulative, r2.hasValidPoints = true);
          }
          "percent" === g2 && (P2.usePercentage = true), "group" !== g2 && (this.stackedYData = b2), P2.oldStacks = {};
        }
        class P {
          constructor(t3) {
          ...
          buildStacks() {
            ...
            if (!o2)
              for (e3 = 0; e3 < n2; e3++)
                s2[e3].modifyStacks();
            g(i3, "afterBuildStacks");
          }
          cleanStacks() {
            this.oldStacks && (this.stacks = this.oldStacks, x(this.stacks, (t3) => {
              x(t3, (t4) => {
          ...
          resetStacks() {
            x(this.stacks, (t3) => {
              x(t3, (e3, i3) => {
                m(e3.touched) && e3.touched < this.stacksTouched ? (e3.destroy(), delete t3[i3]) : (e3.total = null, e3.cumulative = null);
              });
            });
          }
          renderStackTotals() {
            var _a;
            let t3 = this.axis, e3 = t3.chart, i3 = e3.renderer, s2 = this.stacks, o2 = (_a = t3.options.stackLabels) == null ? void 0 : _a.animation, r2 = a(e3, o2 || false), n2 = this.stackTotalGroup = this.stackTotalGroup || i3.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
            n2.translate(e3.plotLeft, e3.plotTop), x(s2, (t4) => {
              x(t4, (t5) => {
                t5.render(n2);
              });
            }), n2.animate({ opacity: 1 }, r2);
          }
        }
        return (n || (n = {})).compose = function t3(e3, i3, s2) {
          if (b(h, t3)) {
            let t4 = i3.prototype, o2 = s2.prototype;
            d(e3, "init", k), d(e3, "destroy", S), t4.getStacks = v, o2.getStackIndicator = M, o2.modifyStacks = C, o2.percentStacker = w, o2.setGroupedPoints = T, o2.setStackedPoints = A;
          }
        }, n;
        ...
        return l.defaultOptions = n(o.defaultOptions, { threshold: 0, legendSymbol: "areaMarker" }), r(l.prototype, { singleStacks: false }), e2.registerSeriesType("area", l), l;
        ...
        class S extends o {
          ...
          translate() {
            let t3 = this, e3 = t3.chart, i3 = t3.options, s2 = t3.dense = t3.closestPointRange * t3.xAxis.transA < 2, r2 = t3.borderWidth = y(i3.borderWidth, s2 ? 0 : 1), n2 = t3.xAxis, a2 = t3.yAxis, h2 = i3.threshold, l2 = y(i3.minPointLength, 5), d2 = t3.getColumnMetrics(), u2 = d2.width, f2 = t3.pointXOffset = d2.offset, x2 = t3.dataMin, b2 = t3.dataMax, v2 = t3.barW = Math.max(u2, 1 + 2 * r2), S2 = t3.translatedThreshold = a2.getThreshold(h2);
            e3.inverted && (S2 -= 0.5), i3.pointPadding && (v2 = Math.ceil(v2)), o.prototype.translate.apply(t3), t3.points.forEach(function(s3) {
              let o2 = y(s3.yBottom, S2), r3 = 999 + Math.abs(o2), g2 = s3.plotX || 0, k = c(s3.plotY, -r3, a2.len + r3);
              s3.stackBox;
              let M, C = Math.min(k, o2), w = Math.max(k, o2) - C, T = u2, A = g2 + f2, P = v2;
              l2 && Math.abs(w) < l2 && (w = l2, M = !a2.reversed && !s3.negative || a2.reversed && s3.negative, m(h2) && m(b2) && s3.y === h2 && b2 <= h2 && (a2.min || 0) < h2 && (x2 !== b2 || (a2.max || 0) <= h2) && (M = !M, s3.negative = !s3.negative), C = Math.abs(C - S2) > l2 ? o2 - l2 : S2 - (M ? l2 : 0)), p(s3.options.pointWidth) && (A -= Math.round(((T = P = Math.ceil(s3.options.pointWidth)) - u2) / 2)), i3.centerInCategory && !i3.stacking && (A = t3.adjustForMissingColumns(A, T, s3, d2)), s3.barX = A, s3.pointWidth = T, s3.tooltipPos = e3.inverted ? [c(a2.len + a2.pos - e3.plotLeft - k, a2.pos - e3.plotLeft, a2.len + a2.pos - e3.plotLeft), n2.len + n2.pos - e3.plotTop - A - P / 2, w] : [n2.left - e3.plotLeft + A + P / 2, c(k + a2.pos - e3.plotTop, a2.pos - e3.plotTop, a2.len + a2.pos - e3.plotTop), w], s3.shapeType = t3.pointClass.prototype.shapeType || "roundedRect", s3.shapeArgs = t3.crispCol(A, s3.isNull ? S2 : C, P, s3.isNull ? 0 : w);
        ...
        return S.defaultOptions = x(o.defaultOptions, i2), u(S.prototype, { directTouch: true, getSymbol: d, negStacks: true, trackerGroups: ["group", "dataLabelsGroup"] }), r.registerSeriesType("column", S), S;
      }), i(e, "Core/Series/DataLabel.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function(t2, e2, i2, s) {
        var o;
        let { getDeferredAnimation: r } = t2, { format: n } = e2, { composed: a } = i2, { defined: h, extend: l, fireEvent: d, isArray: c, isString: p, merge: u, objectEach: g, pick: f, pInt: m, pushUnique: x, splat: y } = s;
        return function(t3) {
          function e3() {
            return k(this).some((t4) => t4 == null ? void 0 : t4.enabled);
          }
          function i3(t4, e4, i4, s3, o3) {
            let r2 = this, n2 = this.chart, a2 = this.isCartesian && n2.inverted, d2 = this.enabledDataSorting, c2 = t4.plotX, p2 = t4.plotY, u2 = i4.rotation, g2 = i4.align, m2 = h(c2) && h(p2) && n2.isInsidePlot(c2, Math.round(p2), { inverted: a2, paneCoordinates: true, series: r2 }), x2 = (i5) => {
              d2 && r2.xAxis && !S2 && r2.setDataLabelStartPos(t4, e4, o3, m2, i5);
            }, y2, b2, v2, S2 = "justify" === f(i4.overflow, d2 ? "none" : "justify"), k2 = this.visible && false !== t4.visible && h(c2) && (t4.series.forceDL || d2 && !S2 || m2 || f(i4.inside, !!this.options.stacking) && s3 && n2.isInsidePlot(c2, a2 ? s3.x + 1 : s3.y + s3.height - 1, { inverted: a2, paneCoordinates: true, series: r2 })), M2 = t4.pos();
            if (k2 && M2) {
              u2 && e4.attr({ align: g2 });
              let t5 = e4.getBBox(true), a3 = [0, 0];
              if (y2 = n2.renderer.fontMetrics(e4).b, s3 = l({ x: M2[0], y: Math.round(M2[1]), width: 0, height: 0 }, s3), l(i4, { width: t5.width, height: t5.height }), u2 ? (S2 = false, b2 = n2.renderer.rotCorr(y2, u2), v2 = { x: s3.x + (i4.x || 0) + s3.width / 2 + b2.x, y: s3.y + (i4.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[i4.verticalAlign] * s3.height }, a3 = [t5.x - Number(e4.attr("x")), t5.y - Number(e4.attr("y"))], x2(v2), e4[o3 ? "attr" : "animate"](v2)) : (x2(s3), e4.align(i4, void 0, s3), v2 = e4.alignAttr), S2 && s3.height >= 0)
                this.justifyDataLabel(e4, i4, v2, t5, s3, o3);
              else if (f(i4.crop, true)) {
                let { x: e5, y: i5 } = v2;
                e5 += a3[0], i5 += a3[1], k2 = n2.isInsidePlot(e5, i5, { paneCoordinates: true, series: r2 }) && n2.isInsidePlot(e5 + t5.width, i5 + t5.height, { paneCoordinates: true, series: r2 });
              }
              i4.shape && !u2 && e4[o3 ? "attr" : "animate"]({ anchorX: M2[0], anchorY: M2[1] });
            }
            o3 && d2 && (e4.placed = false), k2 || d2 && !S2 ? e4.show() : (e4.hide(), e4.placed = false);
          }
          function s2() {
          ...
          function b(t4) {
            ...
            let e4;
            t4 = t4 || this.points;
            let i4 = this, s3 = i4.chart, o3 = i4.options, a2 = s3.renderer, { backgroundColor: l2, plotBackgroundColor: c2 } = s3.options.chart, u2 = a2.getContrast(p(c2) && c2 || p(l2) && l2 || "#000000"), x2 = k(i4), { animation: b2, defer: v2 } = x2[0], M2 = v2 ? r(s3, b2, i4) : { defer: 0, duration: 0 };
            d(this, "drawDataLabels"), ((_a = i4.hasDataLabels) == null ? void 0 : _a.call(i4)) && (e4 = this.initDataLabels(M2), t4.forEach((t5) => {
              var _a2, _b;
              let r2 = t5.dataLabels || [];
              y(S(x2, t5.dlOptions || ((_a2 = t5.options) == null ? void 0 : _a2.dataLabels))).forEach((l4, d2) => {
                var _a3;
                let c3 = l4.enabled && t5.visible && (!t5.isNull || t5.dataLabelOnNull) && function(t6, e5) {
                  let i5 = e5.filter;
                  if (i5) {
                    let e6 = i5.operator, s4 = t6[i5.property], o4 = i5.value;
                    return ">" === e6 && s4 > o4 || "<" === e6 && s4 < o4 || ">=" === e6 && s4 >= o4 || "<=" === e6 && s4 <= o4 || "==" === e6 && s4 == o4 || "===" === e6 && s4 === o4 || "!=" === e6 && s4 != o4 || "!==" === e6 && s4 !== o4;
                  }
                  return true;
                }(t5, l4), { backgroundColor: x3, borderColor: y2, distance: b3, style: v3 = {} } = l4, S2, k2, M3, C, w = {}, T = r2[d2], A = !T, P;
                if (c3 && (k2 = f(l4[t5.formatPrefix + "Format"], l4.format), S2 = t5.getLabelConfig(), M3 = h(k2) ? n(k2, S2, s3) : (l4[t5.formatPrefix + "Formatter"] || l4.formatter).call(S2, l4), C = l4.rotation, !s3.styledMode && (v3.color = f(l4.color, v3.color, p(i4.color) ? i4.color : void 0, "#000000"), "contrast" === v3.color ? ("none" !== x3 && (P = x3), t5.contrastColor = a2.getContrast("auto" !== P && P || t5.color || i4.color), v3.color = P || !h(b3) && l4.inside || 0 > m(b3 || 0) || o3.stacking ? t5.contrastColor : u2) : delete t5.contrastColor, o3.cursor && (v3.cursor = o3.cursor)), w = { r: l4.borderRadius || 0, rotation: C, padding: l4.padding, zIndex: 1 }, s3.styledMode || (w.fill = "auto" === x3 ? t5.color : x3, w.stroke = "auto" === y2 ? t5.color : y2, w["stroke-width"] = l4.borderWidth), g(w, (t6, e5) => {
                  void 0 === t6 && delete w[e5];
                })), !T || c3 && h(M3) && !!T.div == !!l4.useHTML && (T.rotation && l4.rotation || T.rotation === l4.rotation) || (T = void 0, A = true), c3 && h(M3) && (T ? w.text = M3 : (T = C ? a2.text(M3, 0, 0, l4.useHTML).addClass("highcharts-data-label") : a2.label(M3, 0, 0, l4.shape, void 0, void 0, l4.useHTML, void 0, "data-label")) && T.addClass(" highcharts-data-label-color-" + t5.colorIndex + " " + (l4.className || "") + (l4.useHTML ? " highcharts-tracker" : "")), T)) {
                  T.options = l4, T.attr(w), s3.styledMode || T.css(v3).shadow(l4.shadow);
                  let o4 = l4[t5.formatPrefix + "TextPath"] || l4.textPath;
                  o4 && !l4.useHTML && (T.setTextPath(((_a3 = t5.getDataLabelPath) == null ? void 0 : _a3.call(t5, T)) || t5.graphic, o4), t5.dataLabelPath && !o4.enabled && (t5.dataLabelPath = t5.dataLabelPath.destroy())), T.added || T.add(e4), i4.alignDataLabel(t5, T, l4, void 0, A), T.isActive = true, r2[d2] && r2[d2] !== T && r2[d2].destroy(), r2[d2] = T;
                }
              });
              let l3 = r2.length;
              for (; l3--; )
                r2[l3] && r2[l3].isActive ? r2[l3].isActive = false : ((_b = r2[l3]) == null ? void 0 : _b.destroy(), r2.splice(l3, 1));
              t5.dataLabel = r2[0], t5.dataLabels = r2;
            })), d(this, "afterDrawDataLabels");
          }
          function v(t4, e4, i4, s3, o3, r2) {
            let n2 = this.chart, a2 = e4.align, h2 = e4.verticalAlign, l2 = t4.box ? 0 : t4.padding || 0, { x: d2 = 0, y: c2 = 0 } = e4, p2, u2;
            return (p2 = (i4.x || 0) + l2) < 0 && ("right" === a2 && d2 >= 0 ? (e4.align = "left", e4.inside = true) : d2 -= p2, u2 = true), (p2 = (i4.x || 0) + s3.width - l2) > n2.plotWidth && ("left" === a2 && d2 <= 0 ? (e4.align = "right", e4.inside = true) : d2 += n2.plotWidth - p2, u2 = true), (p2 = i4.y + l2) < 0 && ("bottom" === h2 && c2 >= 0 ? (e4.verticalAlign = "top", e4.inside = true) : c2 -= p2, u2 = true), (p2 = (i4.y || 0) + s3.height - l2) > n2.plotHeight && ("top" === h2 && c2 <= 0 ? (e4.verticalAlign = "bottom", e4.inside = true) : c2 += n2.plotHeight - p2, u2 = true), u2 && (e4.x = d2, e4.y = c2, t4.placed = !r2, t4.align(e4, void 0, o3)), u2;
          }
          function S(t4, e4) {
            let i4 = [], s3;
            if (c(t4) && !c(e4))
          ...
          function k(t4) {
            ...
            return y(S(S((_a = e4 == null ? void 0 : e4.series) == null ? void 0 : _a.dataLabels, (_b = e4 == null ? void 0 : e4[t4.type]) == null ? void 0 : _b.dataLabels), t4.options.dataLabels));
          }
          function M(t4, e4, i4, s3, o3) {
            let r2 = this.chart, n2 = r2.inverted, a2 = this.xAxis, h2 = a2.reversed, l2 = ((n2 ? e4.height : e4.width) || 0) / 2, d2 = t4.pointWidth, c2 = d2 ? d2 / 2 : 0;
            e4.startXPos = n2 ? o3.x : h2 ? -l2 - c2 : a2.width - l2 + c2, e4.startYPos = n2 ? h2 ? this.yAxis.height - l2 + c2 : -l2 - c2 : o3.y, s3 ? "hidden" === e4.visibility && (e4.show(), e4.attr({ opacity: 0 }).animate({ opacity: 1 })) : e4.attr({ opacity: 1 }).animate({ opacity: 0 }, void 0, e4.hide), r2.hasRendered && (i4 && e4.attr({ x: e4.startXPos, y: e4.startYPos }), e4.placed = true);
          }
          t3.compose = function t4(r2) {
            if (x(a, t4)) {
              let t5 = r2.prototype;
              t5.initDataLabelsGroup = s2, t5.initDataLabels = o2, t5.alignDataLabel = i3, t5.drawDataLabels = b, t5.justifyDataLabel = v, t5.setDataLabelStartPos = M, t5.hasDataLabels = e3;
            }
          };
        }(o || (o = {})), o;
        ...
        var o;
        let { composed: r } = e2, { series: n } = i2, { merge: a, pick: h, pushUnique: l } = s;
        return function(e3) {
          function i3(t3, e4, i4, s2, o2) {
            let r2 = this.chart.inverted, l2 = t3.series, d = (l2.xAxis ? l2.xAxis.len : this.chart.plotSizeX) || 0, c = (l2.yAxis ? l2.yAxis.len : this.chart.plotSizeY) || 0, p = t3.dlBox || t3.shapeArgs, u = h(t3.below, t3.plotY > h(this.translatedThreshold, c)), g = h(i4.inside, !!this.options.stacking);
            if (p) {
            ...
            i4.align = h(i4.align, !r2 || g ? "center" : u ? "right" : "left"), i4.verticalAlign = h(i4.verticalAlign, r2 || g ? "middle" : u ? "top" : "bottom"), n.prototype.alignDataLabel.call(this, t3, e4, i4, s2, o2), i4.inside && t3.contrastColor && e4.css({ color: t3.contrastColor });
          }
          e3.compose = function e4(s2) {
            t2.compose(n), l(r, e4) && (s2.prototype.alignDataLabel = i3);
          };
        }(o || (o = {})), o;
        ...
        return h.defaultOptions = a(o.defaultOptions, t2), n(h.prototype, { drawTracker: s.prototype.drawTracker, sorted: false, requireSorting: false, noSharedTooltip: true, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"] }), r(h, "afterTranslate", function() {
          this.applyJitter();
        ...
        class y extends r {
          ...
          getX(t3, e3, i3, s2) {
            let o2 = this.center, r2 = this.radii ? this.radii[i3.index] || 0 : o2[2] / 2, n2 = s2.dataLabelPosition, a2 = (n2 == null ? void 0 : n2.distance) || 0, h2 = Math.asin(c((t3 - o2[1]) / (r2 + a2), -1, 1)), l2 = o2[0] + (e3 ? -1 : 1) * (Math.cos(h2) * (r2 + a2)) + (a2 > 0 ? (e3 ? -1 : 1) * (s2.padding || 0) : 0);
            return l2;
          }
          hasData() {
        ...
        var r;
        let { composed: n, noop: a } = e2, { distribute: h } = i2, { series: l } = s, { arrayMax: d, clamp: c, defined: p, pick: u, pushUnique: g, relativeLength: f } = o;
        return function(e3) {
          ...
          function s2(t3, e4) {
            let { center: i4, options: s3 } = this, o3 = i4[2] / 2, r3 = t3.angle || 0, n2 = Math.cos(r3), a2 = Math.sin(r3), h2 = i4[0] + n2 * o3, l2 = i4[1] + a2 * o3, d2 = Math.min((s3.slicedOffset || 0) + (s3.borderWidth || 0), e4 / 5);
          ...
          function o2() {
            var _a;
            let t3 = this, e4 = t3.points, i4 = t3.chart, s3 = i4.plotWidth, o3 = i4.plotHeight, r3 = i4.plotLeft, n2 = Math.round(i4.chartWidth / 3), a2 = t3.center, c2 = a2[2] / 2, g2 = a2[1], m2 = [[], []], x = [0, 0, 0, 0], y = t3.dataLabelPositioners, b, v, S, k = 0;
            t3.visible && ((_a = t3.hasDataLabels) == null ? void 0 : _a.call(t3)) && (e4.forEach((t4) => {
              ...
              (t4.dataLabels || []).forEach((e5, i5) => {
                var _a2;
                let s4 = a2[2] / 2, o4 = e5.options, r4 = f((o4 == null ? void 0 : o4.distance) || 0, s4);
                0 === i5 && m2[t4.half].push(t4), !p((_a2 = o4 == null ? void 0 : o4.style) == null ? void 0 : _a2.width) && e5.getBBox().width > n2 && (e5.css({ width: Math.round(0.7 * n2) + "px" }), e5.shortened = true), e5.dataLabelPosition = this.getDataLabelPosition(t4, r4), k = Math.max(k, r4);
              });
            }), m2.forEach((e5, n3) => {
              let l2 = e5.length, d2 = [], f2, m3, b2 = 0, M;
              l2 && (t3.sortByAngle(e5, n3 - 0.5), k > 0 && (f2 = Math.max(0, g2 - c2 - k), m3 = Math.min(g2 + c2 + k, i4.plotHeight), e5.forEach((t4) => {
                (t4.dataLabels || []).forEach((e6, s4) => {
                  var _a2;
                  let o4 = e6.dataLabelPosition;
                  o4 && o4.distance > 0 && (o4.top = Math.max(0, g2 - c2 - o4.distance), o4.bottom = Math.min(g2 + c2 + o4.distance, i4.plotHeight), b2 = e6.getBBox().height || 21, t4.distributeBox = { target: (((_a2 = e6.dataLabelPosition) == null ? void 0 : _a2.natural.y) || 0) - o4.top + b2 / 2, size: b2, rank: t4.y }, d2.push(t4.distributeBox));
                });
              }), h(d2, M = m3 + b2 - f2, M / 5)), e5.forEach((i5) => {
                (i5.dataLabels || []).forEach((h2) => {
                  let l3 = h2.options || {}, g3 = i5.distributeBox, f3 = h2.dataLabelPosition, m4 = (f3 == null ? void 0 : f3.natural.y) || 0, b3 = l3.connectorPadding || 0, k2 = 0, M2 = m4, C = "inherit";
                  if (f3) {
                    if (d2 && p(g3) && f3.distance > 0 && (void 0 === g3.pos ? C = "hidden" : (S = g3.size, M2 = y.radialDistributionY(i5, h2))), l3.justify)
                      k2 = y.justify(i5, h2, c2, a2);
                    else
                      switch (l3.alignTo) {
                        case "connectors":
                          k2 = y.alignToConnectors(e5, n3, s3, r3);
                          break;
                        case "plotEdges":
                          k2 = y.alignToPlotEdges(h2, n3, s3, r3);
                          break;
                        default:
                          k2 = y.radialDistributionX(t3, i5, M2, m4, h2);
                      }
                    if (f3.attribs = { visibility: C, align: f3.alignment }, f3.posAttribs = { x: k2 + (l3.x || 0) + ({ left: b3, right: -b3 }[f3.alignment] || 0), y: M2 + (l3.y || 0) - h2.getBBox().height / 2 }, f3.computed.x = k2, f3.computed.y = M2, u(l3.crop, true)) {
                      let t4;
                      k2 - (v = h2.getBBox().width) < b3 && 1 === n3 ? (t4 = Math.round(v - k2 + b3), x[3] = Math.max(t4, x[3])) : k2 + v > s3 - b3 && 0 === n3 && (t4 = Math.round(k2 + v - s3 + b3), x[1] = Math.max(t4, x[1])), M2 - S / 2 < 0 ? x[0] = Math.max(Math.round(-M2 + S / 2), x[0]) : M2 + S / 2 > o3 && (x[2] = Math.max(Math.round(M2 + S / 2 - o3), x[2])), f3.sideOverflow = t4;
                    }
                  }
                });
              }));
              ...
              (e5.dataLabels || []).forEach((s4) => {
                var _a2;
                let { connectorColor: o4, connectorWidth: r4 = 1 } = s4.options || {}, n3 = s4.dataLabelPosition;
                if (r4) {
                  let a3;
                  b = s4.connector, n3 && n3.distance > 0 ? (a3 = !b, b || (s4.connector = b = i4.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + e5.colorIndex + (e5.className ? " " + e5.className : "")).add(t3.dataLabelsGroup)), i4.styledMode || b.attr({ "stroke-width": r4, stroke: o4 || e5.color || "#666666" }), b[a3 ? "attr" : "animate"]({ d: e5.getConnectorPath(s4) }), b.attr({ visibility: (_a2 = n3.attribs) == null ? void 0 : _a2.visibility })) : b && (s4.connector = b.destroy());
                }
              });
            })));
          }
          ...
          e3.compose = function e4(h2) {
            if (t2.compose(l), g(n, e4)) {
              let t3 = h2.prototype;
      ...
      }), i(e, "Extensions/OverlappingDataLabels.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function(t2, e2) {
        let { composed: i2 } = t2, { addEvent: s, fireEvent: o, isNumber: r, objectEach: n, pick: a, pushUnique: h } = e2;
        function l(t3) {
          let e3 = t3.length, i3 = this.renderer, s2 = (t4, e4) => !(e4.x >= t4.x + t4.width || e4.x + e4.width <= t4.x || e4.y >= t4.y + t4.height || e4.y + e4.height <= t4.y), n2 = (t4) => {
            let e4 = t4.box ? 0 : t4.padding || 0, s3, o2, n3, a3 = 0, h3 = 0, l3, d2;
            if (t4 && (!t4.alignAttr || t4.placed))
              return s3 = t4.alignAttr || { x: t4.attr("x"), y: t4.attr("y") }, o2 = t4.parentGroup, t4.width || (n3 = t4.getBBox(), t4.width = n3.width, t4.height = n3.height, a3 = i3.fontMetrics(t4.element).h), l3 = t4.width - 2 * e4, (d2 = { left: "0", center: "0.5", right: "1" }[t4.alignValue]) ? h3 = +d2 * l3 : r(t4.x) && Math.round(t4.x) !== t4.translateX && (h3 = t4.x - (t4.translateX || 0)), { x: s3.x + (o2.translateX || 0) + e4 - (h3 || 0), y: s3.y + (o2.translateY || 0) + e4 - a3, width: t4.width - 2 * e4, height: (t4.height || 0) - 2 * e4 };
          }, a2, h2, l2, c2, p, u = false;
          for (let i4 = 0; i4 < e3; i4++)
            (a2 = t3[i4]) && (a2.oldOpacity = a2.opacity, a2.newOpacity = 1, a2.absoluteBox = n2(a2));
          t3.sort((t4, e4) => (e4.labelrank || 0) - (t4.labelrank || 0));
          for (let i4 = 0; i4 < e3; ++i4) {
            c2 = (h2 = t3[i4]) && h2.absoluteBox;
            for (let o2 = i4 + 1; o2 < e3; ++o2)
              p = (l2 = t3[o2]) && l2.absoluteBox, c2 && p && h2 !== l2 && 0 !== h2.newOpacity && 0 !== l2.newOpacity && "hidden" !== h2.visibility && "hidden" !== l2.visibility && s2(c2, p) && ((h2.labelrank < l2.labelrank ? h2 : l2).newOpacity = 0);
          }
          for (let e4 of t3)
            d(e4, this) && (u = true);
        ...
        function d(t3, e3) {
          let i3, s2 = false;
          return t3 && (i3 = t3.newOpacity, t3.oldOpacity !== i3 && (t3.hasClass("highcharts-data-label") ? (t3[i3 ? "removeClass" : "addClass"]("highcharts-data-label-hidden"), s2 = true, t3[t3.isOld ? "animate" : "attr"]({ opacity: i3 }, void 0, function() {
            e3.styledMode || t3.css({ pointerEvents: i3 ? "auto" : "none" });
          }), o(e3, "afterHideOverlappingLabel")) : t3.attr({ opacity: i3 })), t3.isOld = true), s2;
        }
        function c() {
          var _a;
          let t3 = this, e3 = [];
          ...
          for (let i3 of t3.yAxis || [])
            i3.stacking && i3.options.stackLabels && !i3.options.stackLabels.allowOverlap && n(i3.stacking.stacks, (t4) => {
              n(t4, (t5) => {
              ...
              let s2 = (i4) => {
                for (let s3 of i4)
                  s3.visible && (s3.dataLabels || []).forEach((i5) => {
                    var _a2;
                    let o2 = i5.options || {};
                    i5.labelrank = a(o2.labelrank, s3.labelrank, (_a2 = s3.shapeArgs) == null ? void 0 : _a2.height), o2.allowOverlap ?? Number(o2.distance) > 0 ? (i5.oldOpacity = i5.opacity, i5.newOpacity = 1, d(i5, t3)) : e3.push(i5);
                  });
              };
        ...
        return { compose: function t3(e3) {
          if (h(i2, t3)) {
            let t4 = e3.prototype;
            t4.hideOverlappingLabels = l, s(e3, "render", c);
          }
        } };
      }), i(e, "Extensions/BorderRadius.js", [e["Core/Defaults.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function(t2, e2, i2) {
        let { defaultOptions: s } = t2, { composed: o, noop: r } = e2, { addEvent: n, extend: a, isObject: h, merge: l, pushUnique: d, relativeLength: c } = i2, p = { radius: 0, scope: "stack", where: void 0 }, u = r, g = r;
        function f(t3, e3, i3, s2, o2 = {}) {
          let r2 = u(t3, e3, i3, s2, o2), { innerR: n2 = 0, r: a2 = i3, start: h2 = 0, end: l2 = 0 } = o2;
          if (o2.open || !o2.borderRadius)
            return r2;
          let d2 = l2 - h2, p2 = Math.sin(d2 / 2), g2 = Math.max(Math.min(c(o2.borderRadius || 0, a2 - n2), (a2 - n2) / 2, a2 * p2 / (1 + p2)), 0), f2 = Math.min(g2, 2 * (d2 / Math.PI) * n2), m2 = r2.length - 1;
          for (; m2--; )
            !function(t4, e4, i4) {
              let s3, o3, r3;
              ...
              if ("Z" === a3[0] && (a3 = t4[0]), ("M" === n3[0] || "L" === n3[0]) && "A" === a3[0] ? (s3 = n3, o3 = a3, r3 = true) : "A" === n3[0] && ("M" === a3[0] || "L" === a3[0]) && (s3 = a3, o3 = n3), s3 && o3 && o3.params) {
                let n4 = o3[1], a4 = o3[5], h3 = o3.params, { start: l3, end: d3, cx: c2, cy: p3 } = h3, u2 = a4 ? n4 - i4 : n4 + i4, g3 = u2 ? Math.asin(i4 / u2) : 0, f3 = a4 ? g3 : -g3, m3 = Math.cos(g3) * u2;
                r3 ? (h3.start = l3 + f3, s3[1] = c2 + m3 * Math.cos(l3), s3[2] = p3 + m3 * Math.sin(l3), t4.splice(e4 + 1, 0, ["A", i4, i4, 0, 0, 1, c2 + n4 * Math.cos(h3.start), p3 + n4 * Math.sin(h3.start)])) : (h3.end = d3 - f3, o3[6] = c2 + n4 * Math.cos(h3.end), o3[7] = p3 + n4 * Math.sin(h3.end), t4.splice(e4 + 1, 0, ["A", i4, i4, 0, 0, 1, c2 + m3 * Math.cos(d3), p3 + m3 * Math.sin(d3)])), o3[4] = Math.abs(h3.end - h3.start) < Math.PI ? 0 : 1;
              }
            }(r2, m2, m2 > 1 ? f2 : g2);
          return r2;
        }
        function m() {
          ...
          if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let { options: t3, yAxis: e3 } = this, i3 = "percent" === t3.stacking, o2 = (_b = (_a = s.plotOptions) == null ? void 0 : _a[this.type]) == null ? void 0 : _b.borderRadius, r2 = x(t3.borderRadius, h(o2) ? o2 : {}), n2 = e3.options.reversed;
            for (let s2 of this.points) {
              let { shapeArgs: o3 } = s2;
              if ("roundedRect" === s2.shapeType && o3) {
                let { width: h2 = 0, height: l2 = 0, y: d2 = 0 } = o3, p2 = d2, u2 = l2;
                if ("stack" === r2.scope && s2.stackTotal) {
                  let o4 = e3.translate(i3 ? 100 : s2.stackTotal, false, true, false, true), r3 = e3.translate(t3.threshold || 0, false, true, false, true), n3 = this.crispCol(0, Math.min(o4, r3), 0, Math.abs(o4 - r3));
                  p2 = n3.y, u2 = n3.height;
                }
                let g2 = (s2.negative ? -1 : 1) * (n2 ? -1 : 1) == -1, f2 = r2.where;
                !f2 && this.is("waterfall") && Math.abs((s2.yBottom || 0) - (this.translatedThreshold || 0)) > this.borderWidth && (f2 = "all"), f2 || (f2 = "end");
                let m2 = Math.min(c(r2.radius, h2), h2 / 2, "all" === f2 ? l2 / 2 : 1 / 0) || 0;
        ...
        function b(t3, e3, i3, s2, o2 = {}) {
          ...
          if (s2 < c2 - u2) {
            ...
            y2[0] = b2[0] = t3 + i3 - c2 + o3, v[0] = Math.min(y2[0], v[0]), S[0] = Math.max(b2[0], S[0]), k[0] = M[0] = t3 + c2 - o3, y2[1] = M[1] = e3 + s2;
          }
          if (f2) {
            let t4 = C(p2, p2 - f2);
            v[0] += t4, S[0] -= t4, b2[1] = k[1] = e3 + s2 - p2 + f2;
          }
          if (s2 < p2 - f2) {
            let o3 = C(p2, p2 - f2 - s2);
            y2[0] = b2[0] = t3 + i3 - p2 + o3, x2[0] = Math.min(y2[0], x2[0]), m2[0] = Math.max(b2[0], m2[0]), k[0] = M[0] = t3 + p2 - o3, b2[1] = k[1] = e3;
          }
          return r2.length = 0, r2.push(["M", ...m2], ["L", ...x2], ["A", c2, c2, 0, 0, 1, ...y2], ["L", ...b2], ["A", p2, p2, 0, 0, 1, ...v], ["L", ...S], ["A", p2, p2, 0, 0, 1, ...k], ["L", ...M], ["A", c2, c2, 0, 0, 1, ...m2], ["Z"]), r2;
        }
        return { compose: function t3(e3, i3, s2, r2) {
          if (d(o, t3)) {
            let t4 = r2.prototype.symbols;
            n(e3, "afterColumnTranslate", m, { order: 9 }), n(i3, "afterTranslate", y), s2.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY"), u = t4.arc, g = t4.roundedRect, t4.arc = f, t4.roundedRect = b;
          }
        }, optionsToObject: x };
      }), i(e, "Core/Responsive.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function(t2, e2) {
        var i2;
        let { composed: s } = t2, { diffObjects: o, extend: r, find: n, merge: a, pick: h, pushUnique: l, uniqueKey: d } = e2;
        return function(t3) {
          function e3(t4, e4) {
            let i4 = t4.condition, s2 = i4.callback || function() {
              return this.chartWidth <= h(i4.maxWidth, Number.MAX_VALUE) && this.chartHeight <= h(i4.maxHeight, Number.MAX_VALUE) && this.chartWidth >= h(i4.minWidth, 0) && this.chartHeight >= h(i4.minHeight, 0);
            };
            s2.call(this) && e4.push(t4._id);
          }
          function i3(t4, e4) {
            let i4 = this.options.responsive, s2 = this.currentResponsive, r2 = [], h2;
            !e4 && i4 && i4.rules && i4.rules.forEach((t5) => {
              void 0 === t5._id && (t5._id = d()), this.matchResponsiveRule(t5, r2);
            }, this);
            let l2 = a(...r2.map((t5) => n((i4 || {}).rules || [], (e5) => e5._id === t5)).map((t5) => t5 && t5.chartOptions));
            l2.isResponsiveOptions = true, r2 = r2.toString() || void 0;
            let c = s2 && s2.ruleIds;
            r2 !== c && (s2 && this.update(s2.undoOptions, t4, true), r2 ? ((h2 = o(l2, this.options, true, this.collectionsWithUpdate)).isResponsiveOptions = true, this.currentResponsive = { ruleIds: r2, mergedOptions: l2, undoOptions: h2 }, this.update(l2, t4, true)) : this.currentResponsive = void 0);
          }
          t3.compose = function t4(o2) {
            return l(s, t4) && r(o2.prototype, { matchResponsiveRule: e3, setResponsive: i3 }), o2;
          };
        }(i2 || (i2 = {})), i2;
      }), i(e, "masters/highcharts.src.js", [e["Core/Globals.js"], e["Core/Utilities.js"], e["Core/Defaults.js"], e["Core/Animation/Fx.js"], e["Core/Animation/AnimationUtilities.js"], e["Core/Renderer/HTML/AST.js"], e["Core/Templating.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Renderer/SVG/SVGRenderer.js"], e["Core/Renderer/HTML/HTMLElement.js"], e["Core/Renderer/HTML/HTMLRenderer.js"], e["Core/Axis/Axis.js"], e["Core/Axis/DateTimeAxis.js"], e["Core/Axis/LogarithmicAxis.js"], e["Core/Axis/PlotLineOrBand/PlotLineOrBand.js"], e["Core/Axis/Tick.js"], e["Core/Tooltip.js"], e["Core/Series/Point.js"], e["Core/Pointer.js"], e["Core/Legend/Legend.js"], e["Core/Chart/Chart.js"], e["Extensions/ScrollablePlotArea.js"], e["Core/Axis/Stacking/StackingAxis.js"], e["Core/Axis/Stacking/StackItem.js"], e["Core/Series/Series.js"], e["Core/Series/SeriesRegistry.js"], e["Series/Column/ColumnSeries.js"], e["Series/Column/ColumnDataLabel.js"], e["Series/Pie/PieSeries.js"], e["Series/Pie/PieDataLabel.js"], e["Core/Series/DataLabel.js"], e["Extensions/OverlappingDataLabels.js"], e["Extensions/BorderRadius.js"], e["Core/Responsive.js"], e["Core/Color/Color.js"], e["Core/Time.js"]], function(t2, e2, i2, s, o, r, n, a, h, l, d, c, p, u, g, f, m, x, y, b, v, S, k, M, C, w, T, A, P, L, O, D, E, j, I, B, R) {
        return t2.animate = o.animate, t2.animObject = o.animObject, t2.getDeferredAnimation = o.getDeferredAnimation, t2.setAnimation = o.setAnimation, t2.stop = o.stop, t2.timers = s.timers, t2.AST = r, t2.Axis = p, t2.Chart = S, t2.chart = S.chart, t2.Fx = s, t2.Legend = v, t2.PlotLineOrBand = f, t2.Point = y, t2.Pointer = b, t2.Series = w, t2.StackItem = C, t2.SVGElement = h, t2.SVGRenderer = l, t2.Templating = n, t2.Tick = m, t2.Time = R, t2.Tooltip = x, t2.Color = B, t2.color = B.parse, c.compose(l), d.compose(h), b.compose(S), v.compose(S), t2.defaultOptions = i2.defaultOptions, t2.getOptions = i2.getOptions, t2.time = i2.defaultTime, t2.setOptions = i2.setOptions, t2.dateFormat = n.dateFormat, t2.format = n.format, t2.numberFormat = n.numberFormat, e2.extend(t2, e2), t2.distribute = a.distribute, t2.seriesType = T.seriesType, P.compose(A), j.compose(w, L, h, l), D.compose(w), u.compose(p), g.compose(p), E.compose(S), O.compose(L), f.compose(p), I.compose(S), k.compose(p, S, w), M.compose(p, S, w), x.compose(b), t2;
